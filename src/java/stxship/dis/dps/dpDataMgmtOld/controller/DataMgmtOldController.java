 ...
 * 
 */
package stxship.dis.dps.dpDataMgmtOld.controller;
...
import stxship.dis.dps.dpDataMgmtOld.service.DataMgmtOldService;
 ...
 */
@Controller
public class DataMgmtOldController extends CommonController {
	@Resource(name="dataMgmtOldService")
	private DataMgmtOldService dataMgmtService;
	
	@RequestMapping(value = "stxPECDPDataMgmtOld.do")
	public ModelAndView stxPECDPDataOldMgmt(CommandMap commandMap) throws Exception {
		ModelAndView mv = new ModelAndView("/dps/dpDataMgmtOld" + commandMap.get(DisConstants.JSP_NAME));
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "dataMgmtOldMainGrid.do")
	 ...
	 * @return
	 */
	@RequestMapping(value = "dataMgmtOldExcelExport.do")
	...
	@RequestMapping(value = "dataMgmtOldMainGridSave.do")

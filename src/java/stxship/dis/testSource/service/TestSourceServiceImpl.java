package stxship.dis.testSource.service;
...
import stxship.dis.testSource.dao.TestSourceDAO;

@Service("testSourceService")
public class TestSourceServiceImpl extends CommonServiceImpl implements TestSourceService {

	@Resource(name = "testSourceDAO")
	private TestSourceDAO testSourceDAO;
	...
	private String saveGrid(Map<String, Object> commandMap) {
		...
		testSourceDAO.saveGridListAction(pkgParam);

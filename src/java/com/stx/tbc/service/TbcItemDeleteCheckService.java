...
public class TbcItemDeleteCheckService extends AService
{	
	protected ServiceForward forwardPage(HttpServletRequest request, HttpServletResponse response, ArrayList ar, RequestBox box) throws Exception 
	{
		...
		request.setAttribute("deleteCheckedList", ar);
		request.setAttribute("deleteCheckedListSize", Integer.toString(ar.size()));
        ...
        forward.setPath("/WEB-INF/jsp/tbc/tbc_ItemDeleteCheck_"+p_item_type_cd+"_Body.jsp");

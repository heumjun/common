...
public class TbcItemAddStageMainCheckService extends AService
{	
	protected ServiceForward forwardPage(HttpServletRequest request, HttpServletResponse response, ArrayList ar, RequestBox box) throws Exception 
	{
		...
		request.setAttribute("checkResultList", ar);
		request.setAttribute("checkResultListSize", Integer.toString(ar.size()));
        ...
        forward.setPath("/WEB-INF/jsp/tbc/tbc_ItemAddCheck_"+p_item_type_cd+"_Body.jsp");

...
public class TbcItemAddManagerBodyService extends AService
{	
	protected ServiceForward forwardPage(HttpServletRequest request, HttpServletResponse response, ArrayList ar, RequestBox box) throws Exception 
	{
		...
		request.setAttribute("managerList", ar);
		request.setAttribute("managerListSize", Integer.toString(ar.size()));
        ...
        forward.setPath("/WEB-INF/jsp/tbc/tbc_ItemAddManager_"+p_item_type_cd+"_Body.jsp");

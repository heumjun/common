...
public class TbcItemAddMainBackService extends AService
{	
	protected ServiceForward forwardPage(HttpServletRequest request, HttpServletResponse response, ArrayList ar, RequestBox box) throws Exception 
	{
		...
		request.setAttribute("backList", ar);
		request.setAttribute("backListSize", Integer.toString(ar.size()));
        ...
        forward.setPath("/WEB-INF/jsp/tbc/tbc_ItemAddBack_"+p_item_type_cd+"_Body.jsp");

function getMainGridColModel(){
	...
	gridColModel.push({label:'CIRCUIT', name:'attr1', width:60, align:'center', sortable:true, title:false } );
	gridColModel.push({label:'TYPE', name:'attr2', width:60, align:'center', sortable:true, title:false } );
	gridColModel.push({label:'포설D', name:'temp01', width:60, align:'center', sortable:true, title:false } );
	gridColModel.push({label:'LENGTH', name:'attr3', width:50, align:'center', sortable:true, title:false } );
...
function getAddGridColModel(){
		 	...
		 	dataUrl: function(){
  		 	...
  		 	buildSelect: function(data){
     		 	if(typeof(data)=='string'){
      		 	...
      		 	var rtSlt = '<select id="selectJobCd" name="selectJobCd" onchange="javascript:changeAttr(this);">';
	...
	gridColModel.push({label:'CIRCUIT', name:'attr01', width:60, align:'center', sortable:true, title:false, editable:true, 
		cellattr: function (){return 'class="required_cell"';},
		editoptions:{
			dataEvents : [ { type : 'keyup',
			 			    fn : function( e ) {
	...
	gridColModel.push({label:'EA', name:'bom_qty', width:40, align:'center', sortable:true, title:false, editable:false, hidden:true} );
...
//		} 
	...
	gridColModel.push({label:'포설D', name:'temp01', width:60, align:'center', sortable:true, title:false, editable:true, 
		cellattr: function (){return 'class="required_cell"';},
//		editoptions:{
//			dataEvents : [ { type : 'keyup',
//			 			    fn : function( e ) {
...
//		} 
	...
	gridColModel.push({label:'LENGTH', name:'attr03', width:60, align:'center', sortable:true, title:false, editable:true, 
		cellattr: function (){return 'class="required_cell"';},
//		editoptions:{
//			dataEvents : [ { type : 'keyup',
//			 			    fn : function( e ) {
...
//		}
	...
	gridColModel.push({label:'WEIGHT', name:'item_weight', width:60, align:'center', sortable:true, title:false, hidden:true} );
...
function getTribonGridColModel(){
	...
	gridColModel.push({label:'STAGE', name:'stage_no', width:50, align:'center', sortable:true, title:false, editable:true, hidden:true} );
	gridColModel.push({label:'ITEM CODE', name:'item_code', width:100, align:'center', sortable:true, title:false, editable:true} );
	gridColModel.push({label:'DESCRIPTION', name:'item_desc', width:300, align:'left', sortable:true, title:true, editable:true, hidden:true} );
	...
	gridColModel.push({label:'CIRCUIT', name:'attr1', width:60, align:'center', sortable:true, title:false, editable:true} );
	gridColModel.push({label:'TYPE', name:'attr2', width:60, align:'center', sortable:true, title:false, editable:true} );
	gridColModel.push({label:'포셜D', name:'element_value', width:60, align:'center', sortable:true, title:false, editable:true} );
	gridColModel.push({label:'LENGTH', name:'attr3', width:60, align:'center', sortable:true, title:false, editable:true} );
...
function getModifyGridColModel(){
	...
	gridColModel.push({label:'변경 EA', name:'modify_bom_qty', width:60, align:'center', hidden:false } );
	gridColModel.push({label:'PROCESS', name:'process', width:60, align:'center', sortable:true, title:false} );
	gridColModel.push({label:'ERROR_MSG_PROJECT_NO', name:'error_msg_project_no', hidden:true } );
	gridColModel.push({label:'ERROR_MSG_DWG_NO', name:'error_msg_dwg_no', hidden:true } );
	gridColModel.push({label:'ERROR_MSG_BLOCK_NO', name:'error_msg_block_no', hidden:true } );

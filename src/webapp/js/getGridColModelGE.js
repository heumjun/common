function getMainGridColModel(){
	...
	gridColModel.push({label:'ITEM CODE', name:'item_code', width:110, align:'center', sortable:true, title:false, formatter: itemCodeFormatter, unformat:unFormatter } );
	gridColModel.push({label:'ITEM DESC', name:'item_desc', width:300, align:'left', sortable:true, title:false } );
...
function getAddGridColModel(){
	...
	gridColModel.push({label:'M/ITEM DESC', name:'buy_mother_item_desc', width:100, align:'center', sortable:true, title:false, editable:true, hidden:true } );
	gridColModel.push({label:'M/ITEM WEIGHT', name:'buy_mother_item_weight', width:100, align:'center', sortable:true, title:false, editable:true, hidden:true } );
	...
	gridColModel.push({label:'DESCRIPTION', name:'item_desc', width:200, align:'center', sortable:true, title:true } );
	...
	gridColModel.push({label:'WEIGHT', name:'item_weight', width:80, align:'center', sortable:true, title:false } );
...
function getBomGridColModel(){
	...
	gridColModel.push({label:'PENDING', name:'mother_code', width:100, align:'center', sortable:true, title:false } );
	gridColModel.push({label:'ITEM CODE', name:'item_code', width:100, align:'center', sortable:true, title:false} );
	gridColModel.push({label:'ECO NO.', name:'eco_no', width:100, align:'center', sortable:true, title:false, hidden:true } );
	gridColModel.push({label:'EA', name:'bom_qty', width:60, align:'center', sortable:true, title:false} );
	gridColModel.push({label:'OPER', name:'oper', hidden:true } );

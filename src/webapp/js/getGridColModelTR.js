function getMainGridColModel(){
	...
	gridColModel.push({label:'TRAY NO.', name:'tr_tray_no', width:110, align:'center', sortable:true, title:false } );		
	...
	gridColModel.push({label:'DETAIL', name:'bom_item_detail', width:70, align:'center', sortable:true, title:false} );
	gridColModel.push({label:'PAINT1', name:'tr_paint', width:60, align:'center', sortable:true, title:false} );	
	gridColModel.push({label:'재질', name:'tr_material', width:60, align:'center', sortable:true, title:false} );
	gridColModel.push({label:'PAD', name:'tr_pad', width:60, align:'center', sortable:true, title:false} );	
...
function getAddGridColModel(){
	...
	gridColModel.push({label:'M/TRAY NO.', name:'buy_mother_key_no', width:100, align:'center', sortable:true, title:false, editable:true, hidden:true } );
	...
	gridColModel.push({label:'TRAY NO.', name:'key_no', width:100, align:'center', sortable:true, title:false, editable:true, cellattr: function (){return 'class="required_cell"';},
		/*cellattr: function (){return 'class="required_cell"';},*/
		editoptions: { 
            dataEvents: [{
            	type: 'blur'
...
//		}
	...
	gridColModel.push({label:'DETAIL', name:'temp01', width:60, align:'center', sortable:true, title:false, editable:true,
		cellattr: function (){return 'class="required_cell"';}
	} );
...
//		}
	...
	gridColModel.push({label:'재질', name:'temp02', width:60, align:'center', sortable:true, title:false, editable:true, 
		cellattr: function (){return 'class="required_cell"';},
//		editoptions:{
//			dataEvents : [ { type : 'keyup',
//			 			    fn : function( e ) {
...
//		}
	...
	gridColModel.push({label:'PAD', name:'temp03', width:60, align:'center', sortable:true, title:false, editable:true, 
		cellattr: function (){return 'class="required_cell"';}
	} );
...
function getTribonGridColModel(){
	...
	gridColModel.push({label:'TRAY NO.', name:'tray_no', width:60, align:'center', sortable:true, title:false, editable:true} );
...
function getModifyGridColModel(){
	...
	gridColModel.push({label:'TRAY NO.', name:'key_no', width:100, align:'center', sortable:true, title:false} );
	gridColModel.push({label:'변경 TRAY NO', name:'temp07', width:100, align:'center', sortable:true, editable:true, title:false, cellattr: function (){return 'class="required_cell"';},
		editoptions: { 
            dataEvents: [{
            	type: 'change'
            	, fn: function(e) {

function getMainGridColModel(){
	...
	gridColModel.push({label:'DESCRIPTION', name:'item_desc', width:300, align:'left', sortable:true, title:false } );
	gridColModel.push({label:'EA', name:'ea', width:30, align:'center', sortable:true, title:false} );
	gridColModel.push({label:'VALUE', name:'l_value', width:100, align:'center', sortable:true, title:false, editable:true} );
	gridColModel.push({label:'MOTHER BUY', name:'mother_buy', width:100, align:'center', sortable:true, title:false} );
	...
	gridColModel.push({label:'ECO NO.', name:'eco_no', width:80, align:'center', sortable:true, title:false, formatter: ecoFormatter, unformat:unFormatter} );
	...
	gridColModel.push({label:'REMARK', name:'remark', width:100, align:'center', sortable:true, title:false, editable:true} );
	...
	gridColModel.push({label:'EMS_EXISTS_FLAG', name:'ems_exists_flag', width:50, align:'center', sortable:true, title:false, hidden:true} );	
...
function getAddGridColModel(){
	...
	gridColModel.push({label:'M/KEY NO.', name:'buy_mother_key_no', width:100, align:'center', sortable:true, title:false, editable:true, hidden:true } );
	...
	gridColModel.push({label:'VALUE', name:'temp01', width:80, align:'center', sortable:true, title:false, editable:true} );
	gridColModel.push({label:'MOTHER BUY', name:'temp02', width:100, align:'center', sortable:true, title:false, editable:true,} );
	gridColModel.push({label:'REMARK', name:'temp03', width:60, align:'center', sortable:true, title:false, editable:true} );
...
function getTribonGridColModel(){
	...
	gridColModel.push({label:'MARK NO', name:'attr1', width:160, align:'left', sortable:true, title:true, editable:true} );
...
function getModifyGridColModel(){
	...
	gridColModel.push({label:'MARK NO', name:'key_no', width:60, align:'left', sortable:true, title:true, editable:true, hidden:true} );
...
function getDeleteGridColModel(){
	...
	gridColModel.push({label:'VALUE', name:'l_value', width:100, align:'center', sortable:true, title:false, editable:true} );
	gridColModel.push({label:'MOTHER BUY', name:'mother_buy', width:100, align:'center', sortable:true, title:false} );
	gridColModel.push({label:'DETAIL', name:'item_desc_detail', width:60, align:'center', sortable:true, title:false, editable:true, hidden: true} );
	gridColModel.push({label:'PAINT1', name:'paint_code1', width:60, align:'center', sortable:true, title:false, editable:true, hidden: true} );
	gridColModel.push({label:'PAINT2', name:'paint_code2', width:60, align:'center', sortable:true, title:false, editable:true, hidden: true} );
	gridColModel.push({label:'PROCESS', name:'process', width:60, align:'center', sortable:true, title:false} );
...
function getBomGridColModel(){
	...
	gridColModel.push({label:'EA', name:'bom_qty', width:60, align:'center', sortable:true, title:false} );
	gridColModel.push({label:'WEIGHT', name:'item_weight', width:60, align:'center', sortable:true, title:false, editable:true} );
	gridColModel.push({label:'DETAIL', name:'item_desc_detail', width:60, align:'center', sortable:true, title:false, editable:true} );

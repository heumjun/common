function getMainGridColModel(){
	...
	gridColModel.push({label:'MARK NO.', name:'attr1', width:60, align:'center', sortable:true, title:false } );
	...
	gridColModel.push({label:'ECO NO.', name:'eco_no', width:65, align:'center', sortable:true, title:false, formatter: ecoFormatter, unformat:unFormatter, cellattr: function (){return 'style="cursor:pointer"';} } );
...
function getAddGridColModel(){
	...
	gridColModel.push({label:'M/MARK NO.', name:'buy_mother_key_no', width:100, align:'center', sortable:true, title:false, editable:true, hidden:true } );
	...
	gridColModel.push({label:'MARK NO.', name:'attr01', width:100, align:'center', sortable:true, title:false, editable:true, 
		cellattr: function (){return 'class="required_cell"';},
		editoptions:{
			dataEvents : [ { type : 'keyup',
			 			    fn : function( e ) {
...
//			 	            	, fn: function(e) {
//			 			    		var item = jqGridObj.jqGrid( 'getRowData', idRow );
//			 			    		if($("input[name=p_item_type_cd]").val() == "OU" && item.item_code == "" && item.attr01 != ""){
//			 			    			changeEditableByContainRow(jqGridObj, kRow-1, 'item_code','',true);
//				 			   		}
//			 	                }
//			 				}
						]
...
//		}
	...
	gridColModel.push({label:'DETAIL', name:'bom_item_detail', width:60, align:'center', sortable:true, title:false, editable:true} );
...
function getTribonGridColModel(){
	...
	gridColModel.push({label:'MARK NO', name:'attr1', width:80, align:'center', sortable:true, title:true, editable:true} );
	gridColModel.push({label:'DESCRIPTION', name:'item_desc', width:420, align:'left', sortable:true, title:true, editable:true} );
...
function getModifyGridColModel(){
	...
	gridColModel.push({label:'MARK NO', name:'key_no', width:60, align:'center', sortable:true, title:true, editable:true} );
	//gridColModel.push({label:'ECO NO.', name:'eco_no', width:80, align:'center', sortable:true, title:false} );
	gridColModel.push({label:'DETAIL', name:'bom_item_detail', width:90, align:'center', sortable:true, title:false} );
	gridColModel.push({label:'변경 DETAIL', name:'modify_detail', width:90, align:'center', sortable:true, editable:true, title:false} );

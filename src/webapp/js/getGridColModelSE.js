function getMainGridColModel(){
	...
	gridColModel.push({label:'ITEM CODE', name:'item_code', width:120, align:'center', sortable:true, title:false, formatter: itemCodeFormatter, unformat:unFormatter } );
	gridColModel.push({label:'ITEM_CATALOG', name:'item_catalog', width:60, align:'center', sortable:true, title:false, hidden:true } );
	gridColModel.push({label:'SEAT NO.', name:'se_seat_no', width:55, align:'center', sortable:true, title:false } );		
	...
	gridColModel.push({label:'TYPE', name:'se_type', width:50, align:'center', sortable:true, title:false} );
	gridColModel.push({label:'DETAIL', name:'bom_item_detail', width:120, align:'center', sortable:true, title:false} );
	gridColModel.push({label:'PAINT1', name:'se_paint', width:60, align:'center', sortable:true, title:false} );	
	gridColModel.push({label:'재질', name:'se_material', width:100, align:'center', sortable:true, title:false} );
	gridColModel.push({label:'E_BOLT', name:'se_earth_bolt', width:60, align:'center', sortable:true, title:false} );
	gridColModel.push({label:'PAD', name:'se_pad', width:60, align:'center', sortable:true, title:false} );	
...
function getAddGridColModel(){
	...
	gridColModel.push({label:'STAGE', name:'stage_no', width:60, align:'center', sortable:true, title:false, editable:true, editoptions:{size:"10",maxlength:"10"} });
	...
	gridColModel.push({label:'M/ITEM CODE', name:'buy_mother_item_code', width:130, align:'center', sortable:true, title:false, editable:true, hidden:true } );
	gridColModel.push({label:'M/SEAT NO.', name:'buy_mother_key_no', width:100, align:'center', sortable:true, title:false, editable:true, hidden:true } );
	gridColModel.push({label:'ITEM CODE', name:'item_code', width:130, align:'center', sortable:true, title:false, editable:true, 
		cellattr: function (){return 'class="required_cell"';},
		editoptions:{
	...
	gridColModel.push({label:'CATALOG', name:'item_category_code', width:100, align:'center', sortable:true, title:false, editable:true, 
		cellattr: function (){return 'class="required_cell"';},
		editoptions:{
			dataEvents : [ { type : 'keyup',
			 			    fn : function( e ) {
	...
	gridColModel.push({label:'SEAT NO.', name:'key_no', width:100, align:'center', sortable:true, title:false, editable:true, 
		cellattr: function (){return 'class="required_cell"';},
		editoptions:{
			dataEvents : [ { type : 'keyup',
			 			    fn : function( e ) {
...
//		}
	...
	gridColModel.push({label:'TYPE', name:'temp01', width:60, align:'center', sortable:true, title:false, editable:true, 
		cellattr: function (){return 'class="required_cell"';},
//		editoptions:{
//			dataEvents : [ { type : 'keyup',
//			 			    fn : function( e ) {
...
//		}
	...
	gridColModel.push({label:'DETAIL', name:'temp02', width:60, align:'center', sortable:true, title:false, editable:true,
		cellattr: function (){return 'class="required_cell"';}
	} );
	gridColModel.push({label:'PAINT', name:'paint_code1', width:60, align:'center', sortable:true, title:false, editable:true, 
		cellattr: function (){return 'class="required_cell"';},
//		editoptions:{
//			dataEvents : [ { type : 'keyup',
//			 			    fn : function( e ) {
...
//		}
	...
	gridColModel.push({label:'재질', name:'temp03', width:60, align:'center', sortable:true, title:false, editable:true, 
		cellattr: function (){return 'class="required_cell"';},
//		editoptions:{
//			dataEvents : [ { type : 'keyup',
//			 			    fn : function( e ) {
...
//		}
	...
	gridColModel.push({label:'E_BOLT', name:'temp04', width:60, align:'center', sortable:true, title:false, editable:true, 
		cellattr: function (){return 'class="required_cell"';}
	} );
	
	gridColModel.push({label:'PAD', name:'temp05', width:60, align:'center', sortable:true, title:false, editable:true, 
		cellattr: function (){return 'class="required_cell"';}
	} );
...
function getTribonGridColModel(){
	...
	gridColModel.push({label:'SEAT NO.', name:'seat_no', width:60, align:'center', sortable:true, title:false, editable:true} );
	...
	gridColModel.push({label:'DETAIL', name:'item_desc_detail', width:100, align:'left', sortable:true, title:true, editable:true} );
	gridColModel.push({label:'E_BOLT', name:'earth_bolt', width:60, align:'left', sortable:true, title:true, editable:true} );	
	gridColModel.push({label:'PAINT', name:'paint_code1', width:50, align:'left', sortable:true, title:true, editable:true} );
	gridColModel.push({label:'W1', name:'seat_dim_w1', width:30, align:'left', sortable:true, title:true, editable:true} );
	gridColModel.push({label:'W', name:'seat_dim_w', width:30, align:'left', sortable:true, title:true, editable:true} );
	gridColModel.push({label:'A', name:'seat_dim_a', width:30, align:'left', sortable:true, title:true, editable:true} );
	gridColModel.push({label:'L1', name:'seat_dim_l1', width:30, align:'left', sortable:true, title:true, editable:true} );
	gridColModel.push({label:'L', name:'seat_dim_l', width:30, align:'left', sortable:true, title:true, editable:true} );
	gridColModel.push({label:'B', name:'seat_dim_b', width:30, align:'left', sortable:true, title:true, editable:true} );
	gridColModel.push({label:'D', name:'seat_dim_d', width:30, align:'left', sortable:true, title:true, editable:true} );
	gridColModel.push({label:'D', name:'seat_dim_d1', width:30, align:'left', sortable:true, title:true, editable:true} );
	gridColModel.push({label:'A1', name:'seat_dim_a1', width:30, align:'left', sortable:true, title:true, editable:true} );
	gridColModel.push({label:'1', name:'seat_material1', width:30, align:'left', sortable:true, title:true, editable:true} );
	gridColModel.push({label:'2', name:'seat_material2', width:30, align:'left', sortable:true, title:true, editable:true} );
	gridColModel.push({label:'3', name:'seat_material3', width:30, align:'left', sortable:true, title:true, editable:true} );
...
function getModifyGridColModel(){
	...
	gridColModel.push({label:'BUY-BUY FLAG', name:'buy_buy_flag', width:50, align:'center', sortable:true, title:false, hidden:true} );
	gridColModel.push({label:'PENDING', name:'mother_code', width:100, align:'center', sortable:true, title:false } );
	gridColModel.push({label:'ITEM CODE', name:'item_code', width:130, align:'center', sortable:true, title:false} );
	gridColModel.push({label:'SEAT NO.', name:'key_no', width:100, align:'center', sortable:true, title:false} );
	//gridColModel.push({label:'ECO NO.', name:'eco_no', width:100, align:'center', sortable:true, title:false} );
	gridColModel.push({label:'DETAIL', name:'bom_item_detail', width:60, align:'center', sortable:true, title:false} );
	gridColModel.push({label:'변경 DETAIL', name:'modify_detail', width:60, align:'center', sortable:true, editable:true, title:false, cellattr: function (){return 'class="required_cell"';},} );

					...
					<td width="93%">
						<fieldset style="border:none; position:relative; float:left; width:65%;">
							...
							<table class="searchArea2 conSearch">
								<tr>
									<th>PROJECT</th>
									<td><input type="text" id="p_project_no" name="p_project_no" alt="Project" class="required" style="width: 80px; text-align: center; ime-mode:disabled; text-transform: uppercase;" onchange="onlyUpperCase(this);getShipType();" value="${project_no}"/> <input type="button" id="btn_project_no" name="btn_project_no"
									...
									<th>ITEM DESC</th>
									<td><input type="text" id="p_item_desc" name="p_item_desc"  class="toUpper wid180" style="width: 120px;text-align: center;" onchange="javascript:this.value=this.value.toUpperCase();" value=""/></td>
								</tr>
								<tr>
									<th>ITEM CODE</th>
		...
		$(document).ready(
				function() {
						...
						onCellSelect : function( rowid, iCol, cellcontent, e ) {
							...
							if ( rowid != null ) {
								...
								if(colName['index'] == "item_attr"){
									...
									var rs = window.showModalDialog( "popUpItemDetail.do?p_item_code=" + param[0] + "&p_item_catalog=" + param[1],
											param,
					...
					$("#btnSelect").click(function() {
						...
						var arg = "&p_project_no="+$('#p_project_no').val()+
									"&p_mother_code="+$('#p_mother_code').val()+
									"&p_item_desc="+$('#p_item_desc').val()+

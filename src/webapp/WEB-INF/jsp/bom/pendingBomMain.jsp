...
<form id="application_form" name="application_form" method="post">
	<div class="mainDiv" id="mainDiv">
		...
		<input type="hidden" name="p_item_type_cd" value="PD" />		
		...
		<col width="*"/>
			<tr>
				<th>ECO No.</th>
				<td>
					<input type="text" name="p_eco_no" class="required" value="" style="width:100px;" />
					<input type="button" value="ECO 추가" id="btnCreateEco" class="btn_blue2" style=" height:22px;"/>
				</td>
...
<script type="text/javascript" >
	...
	$(document).ready(function(){	
		...
		///js//getGridColModel.js.js에서 그리드의 colomn을 받아온다.
		var gridColModel = getBomGridColModel();
		...
		$("#btnApply").click(function(){
			...
			getGridChangedData(jqGridObj,function(data) {
				...
				if(confirm("ECO 적용하시겠습니까?")){
					...
					$(".loadingBoxArea").show();
					$.post("pendingBomApplyAction.do?pending_id="+encodeURIComponent(pending_id), formData, function(data)
					{	
						$(".loadingBoxArea").hide();

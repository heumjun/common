...
<body>
	<div id="mainDiv" class="mainDiv">
		<form id="application_form" name="application_form">
			...
			<div class="subtitle">
				BOM 편집 <span class="guide"><img src="/images/content/yellow.gif" />&nbsp;필수입력사항</span>
			</div>
			<table>
				<tr>
					<td width="93%">
						<fieldset style="border:none; position:relative; float:left; width:65%;">
							<legend  class="sc_tit sc_tit2">ITEM</legend>
							<table class="searchArea2 conSearch">
								<tr>
									<th>PROJECT</th>
									<td><input type="text" id="p_project_no" name="p_project_no" style="width: 80px;text-align: center;ime-mode:disabled; text-transform: uppercase;" onchange="onlyUpperCase(this);getShipType();" value="${project_no}"/> <input type="button" id="btn_project_no" name="btn_project_no"
										class="btn_gray2" value="검색" /></td>
									<th>MOTHER CODE</th>
									<td colspan="3"><input type="text" id="p_mother_code" name="p_mother_code"  class="toUpper wid180" style="width: 120px;text-align: center;" onchange="javascript:this.value=this.value.toUpperCase();" value="${mother_code}"/></td>
								</tr>
								<tr>
									<th>ITEM CODE</th>
						...
						<fieldset style="border:none; position:relative; float:left; width:33%;">
							<legend  class="sc_tit sc_tit2">ECO</legend>
							<table class="searchArea2 conSearch" style="padding-top:15px">
								<tr>
									<th>ECO</th>
									<td><input type="text" name="p_eco_no" id="p_eco_no"
										style="width: 80px;" /> <input type="button" id="btnEcoCode" name="btnEcoCode" value="검색" class="btn_gray2" /></td>
									<th>생성자</th>
					...
					<legend  class="sc_tit sc_tit2">SELECTED CODE</legend>
						<table class="searchArea2 conSearch">
							...
							<tr>
								...
								<td style="text-align: center;">
									<span id="selectMotherCode"></span>
								</td>
								<td style="text-align: center;">
									<span id="selectProjectNo"></span>
								</td>
								<td style="text-align: center;">
									<span id="selectDescription"></span>
								</td>
								<td style="text-align: center;">
									<span id="selectStatesFlag"></span>
								</td>
								<td style="text-align: center;">
									<span id="selectBomType"></span>
								</td>
								<!-- <td style="text-align: center;">
									<span id="selectStatus"></span>
								</td> -->
								<td style="text-align: center;">
									<span id="selectCatalog"></span>
								</td>
								<td style="text-align: center;">
									<span id="selectUom"></span>
								</td>
								<td style="text-align: center;">
									<span id="selectQty"></span>
								</td>
								<td style="text-align: center;">
									<span id="selectEcoNo"></span>
								</td>
								<td style="text-align: center;">
									<span id="selectEcoCreater"></span>
								</td>
				...
				<div id="tabs" style="position: absolute; border:none;float:left; width: 18%;margin:3px 0 0 0;">
				<div id="slider"></div>
					<ul>
				...
				<div style="float:right; width: 81%; margin:5px 0 0 0;" id="divBomList1" >
					<table>
						<tr>
						<td>
						...
						<td width="80px"><input type="text" id="p_ship_type" name="p_ship_type" style="width: 30px;" /> <c:if
							...
							<input type="button" id="btnShipType" value="검색" style="" class="btn_blue" />
						</c:if></td>
	...
	<script type="text/javascript">
		...
		$(function() {
		    ...
		    $( "#slider" ).slider({
		    	slide: function( event, ui ) {
					...
					fn_insideGridresize($(window), $("#divBomList1"), $("#bomList1"), 211);
		    	}
		    });
		});
		$(document).ready(
				function() {
					...
					$("#treegrid1").jqGrid({
						...
						colModel : [ { name : 'lev', index : 'lev', width : 80, align : "left", hidden : true },
						             ...
						             { name : 'item_code', index : 'item_code', width: 400, align : "left", sortable : false},
						             ...
						             { name : 'item_desc', index : 'item_desc', width : 255, align : "left", hidden : true }, 
						             ...
						             { name : 'eco_no', index : 'eco_no', width : 80, align : "center", hidden : true }, 
			            ...
			            gridComplete : function() {
							...
							for ( var i = 0; i < rows.length; i++ ) {
								...
								if( leaf != "true" && leaf != "0"  ) {
									$( "#treegrid1" ).jqGrid( 'setCell', rows[i], 'item_code', '', { background : '#afc2fa' } );
								}
							}
					...
					$( "#bomList1" ).jqGrid( {
						...
						url:'',
						postData : fn_getFormData("#application_form"),
						colNames : [ '현황','LV', 'MOTHER CODE', '+1 LV CODE',
						             'BOM TYPE', '상태', 'CATALOG', '...', 'DESCRIPTION', 'UOM', 'QTY', 'DWG No', '...', 'Creator',  'Item 속성', 'BOM 속성', 'ECO NO', 'ECO 생성자','History',
						             'enable_flag_changed', 'crud',''
						             ,'attr_1','attr_2','attr_3','attr_4','attr_5','attr_6','attr_7','attr_8','attr_9','attr_10','attr_11','attr_12','attr_13','attr_14','attr_15'
						             ,'code_1','code_2','code_3','code_4','code_5','code_6','code_7','code_8','code_9','code_10','code_11','code_12','code_13','code_14','code_15'
						             ,'add_1','add_2','add_3','add_4','add_5','add_6','add_7','add_8','add_9','add_10','add_11','add_12','add_13','add_14','add_15'
						             ,'bom1','bom2','bom3','bom4','bom5','bom6','bom7','bom8','bom9','bom10','bom11','bom12','bom13','bom14','bom15', 'states_flag','F-NO'],
						colModel : [ { name : 'states_flag_desc', index : 'states_flag_desc', width : 110, align: "center"},
						             { name : 'lev', index : 'lev', width : 80, align : "left", hidden : true }, 
						             { name : 'mother_code', index : 'mother_code', width : 100, align : "left", hidden : true },
						             { name : 'item_code', index : 'item_code', width: 100, align : "center" , editable : true},
						             { name : 'bom_type', index : 'bom_type', width : 40, align : "center" , hidden : true },
						             { name : 'item_states_desc', index : 'item_states_desc', width : 100, align : "center" , hidden : true},
						             { name : 'item_catalog', index : 'item_catalog', width : 80, align : "center" },
						             { name : 'job_catalog_popup', index : 'job_catalog_popup', align : 'center', width : 30 , hidden : true},
						             { name : 'item_desc', index : 'item_desc', width : 255, align : "left" , editable : true}, 
						             { name : 'uom', index : 'uom', width : 40, align : "center" }, 
						             { name : 'qty', index : 'qty', width : 40, align : "right" }, 
						             { name : 'dwg_no', index : 'dwg_no', width : 80, align : "center", editable : false, hidden : true},
						             { name : 'dwg_no_popup', index : 'dwg_no_popup', align : 'center', width : 30, hidden : true},
						             { name : 'emp_no', index : 'emp_no', width : 160, align : "center" , hidden : true}, 
						             { name : 'item_attr', index : 'item_attr', width : 50, align : "center" },
						             { name : 'bom_attr', index : 'bom_attr', width : 50, align : "center" },
						             { name : 'eco_no', index : 'eco_no', width : 80, align : "center" }, 
						             { name : 'created_by', index : 'created_by', width : 180, align : "center" },
						             { name : 'history', index : 'history', width : 70, align : "center", classes : "handcursor" , hidden : true },
						             { name : 'enable_flag_changed', index : 'enable_flag_changed', width : 25, hidden : true},
						             { name : 'oper', index : 'oper', width : 25, hidden : true},
						             { name : 'weight', index : 'weight', width : 25, hidden : true},
						             { name : 'attr1', index : 'attr1', width : 25, hidden : true},
						             { name : 'attr2', index : 'attr2', width : 25, hidden : true},
						             { name : 'attr3', index : 'attr3', width : 25, hidden : true},
						             { name : 'attr4', index : 'attr4', width : 25, hidden : true},
						             { name : 'attr5', index : 'attr5', width : 25, hidden : true},
						             { name : 'attr6', index : 'attr6', width : 25, hidden : true},
						             { name : 'attr7', index : 'attr7', width : 25, hidden : true},
						             { name : 'attr8', index : 'attr8', width : 25, hidden : true},
						             { name : 'attr9', index : 'attr9', width : 25, hidden : true},
						             { name : 'attr10', index : 'attr10', width : 25, hidden : true},
						             { name : 'attr11', index : 'attr11', width : 25, hidden : true},
						             { name : 'attr12', index : 'attr12', width : 25, hidden : true},
						             { name : 'attr13', index : 'attr13', width : 25, hidden : true},
						             { name : 'attr14', index : 'attr14', width : 25, hidden : true},
						             { name : 'attr15', index : 'attr15', width : 25, hidden : true},
						             { name : 'attr1_code', index : 'attr1_code', width : 25, hidden : true},
						             { name : 'attr2_code', index : 'attr2_code', width : 25, hidden : true},
						             { name : 'attr3_code', index : 'attr3_code', width : 25, hidden : true},
						             { name : 'attr4_code', index : 'attr4_code', width : 25, hidden : true},
						             { name : 'attr5_code', index : 'attr5_code', width : 25, hidden : true},
						             { name : 'attr6_code', index : 'attr6_code', width : 25, hidden : true},
						             { name : 'attr7_code', index : 'attr7_code', width : 25, hidden : true},
						             { name : 'attr8_code', index : 'attr8_code', width : 25, hidden : true},
						             { name : 'attr9_code', index : 'attr9_code', width : 25, hidden : true},
						             { name : 'attr10_code', index : 'attr10_code', width : 25, hidden : true},
						             { name : 'attr11_code', index : 'attr11_code', width : 25, hidden : true},
						             { name : 'attr12_code', index : 'attr12_code', width : 25, hidden : true},
						             { name : 'attr13_code', index : 'attr13_code', width : 25, hidden : true},
						             { name : 'attr14_code', index : 'attr14_code', width : 25, hidden : true},
						             { name : 'attr15_code', index : 'attr15_code', width : 25, hidden : true},
						             { name : 'add_attr1', index : 'add_attr1', width : 25, hidden : true},
						             { name : 'add_attr2', index : 'add_attr2', width : 25, hidden : true},
						             { name : 'add_attr3', index : 'add_attr3', width : 25, hidden : true},
						             { name : 'add_attr4', index : 'add_attr4', width : 25, hidden : true},
						             { name : 'add_attr5', index : 'add_attr5', width : 25, hidden : true},
						             { name : 'add_attr6', index : 'add_attr6', width : 25, hidden : true},
						             { name : 'add_attr7', index : 'add_attr7', width : 25, hidden : true},
						             { name : 'add_attr8', index : 'add_attr8', width : 25, hidden : true},
						             { name : 'add_attr9', index : 'add_attr9', width : 25, hidden : true},
						             { name : 'add_attr10', index : 'add_attr10', width : 25, hidden : true},
						             { name : 'add_attr11', index : 'add_attr11', width : 25, hidden : true},
						             { name : 'add_attr12', index : 'add_attr12', width : 25, hidden : true},
						             { name : 'add_attr13', index : 'add_attr13', width : 25, hidden : true},
						             { name : 'add_attr14', index : 'add_attr14', width : 25, hidden : true},
						             { name : 'add_attr15', index : 'add_attr15', width : 25, hidden : true},
						             { name : 'bom1', index : 'bom1', width : 25, hidden : true},
						             { name : 'bom2', index : 'bom2', width : 25, hidden : true},
						             { name : 'bom3', index : 'bom3', width : 25, hidden : true},
						             { name : 'bom4', index : 'bom4', width : 25, hidden : true},
						             { name : 'bom5', index : 'bom5', width : 25, hidden : true},
						             { name : 'bom6', index : 'bom6', width : 25, hidden : true},
						             { name : 'bom7', index : 'bom7', width : 25, hidden : true},
						             { name : 'bom8', index : 'bom8', width : 25, hidden : true},
						             { name : 'bom9', index : 'bom9', width : 25, hidden : true},
						             { name : 'bom10', index : 'bom10', width : 25, hidden : true},
						             { name : 'bom11', index : 'bom11', width : 25, hidden : true},
						             { name : 'bom12', index : 'bom12', width : 25, hidden : true},
						             { name : 'bom13', index : 'bom13', width : 25, hidden : true},
						             { name : 'bom14', index : 'bom14', width : 25, hidden : true},
						             { name : 'bom15', index : 'bom15', width : 25, hidden : true},
						             { name : 'states_flag', index : 'states_flag', width : 25, hidden : true},
						             { name : 'findnumber', index : 'findnumber', width : 30, align : "right", hidden : true}
						           ],
						gridview : true,
						cmTemplate: { title: false },
						...
						onCellSelect : function( rowid, iCol, cellcontent, e ) {
							...
							if ( rowid != null ) {
								...
								if(colName['index'] == "item_attr"){
									...
									var rs = window.showModalDialog( "popUpItemDetail.do",
											param,
										"dialogWidth:500px; dialogHeight:590px; center:on; scroll:off; status:off" );
									if ( rs != null ) {
										var item = $( '#bomList1' ).jqGrid( 'getRowData', rowid );
										$( "#bomList1" ).setRowData( rowid, { attr1: rs["01"] } );
										$( "#bomList1" ).setRowData( rowid, { attr2: rs["02"] } );
										$( "#bomList1" ).setRowData( rowid, { attr3: rs["03"] } );
										$( "#bomList1" ).setRowData( rowid, { attr4: rs["04"] } );
										$( "#bomList1" ).setRowData( rowid, { attr5: rs["05"] } );
										$( "#bomList1" ).setRowData( rowid, { attr6: rs["06"] } );
										$( "#bomList1" ).setRowData( rowid, { attr7: rs["07"] } );
										$( "#bomList1" ).setRowData( rowid, { attr8: rs["08"] } );
										$( "#bomList1" ).setRowData( rowid, { attr9: rs["09"] } );
										$( "#bomList1" ).setRowData( rowid, { attr10: rs["10"] } );
										$( "#bomList1" ).setRowData( rowid, { attr11: rs["11"] } );
										$( "#bomList1" ).setRowData( rowid, { attr12: rs["12"] } );
										$( "#bomList1" ).setRowData( rowid, { attr13: rs["13"] } );
										$( "#bomList1" ).setRowData( rowid, { attr14: rs["14"] } );
										$( "#bomList1" ).setRowData( rowid, { attr15: rs["15"] } );
										
										$( "#bomList1" ).setRowData( rowid, { attr1_code: rs["01_code"] } );
										$( "#bomList1" ).setRowData( rowid, { attr2_code: rs["02_code"] } );
										$( "#bomList1" ).setRowData( rowid, { attr3_code: rs["03_code"] } );
										$( "#bomList1" ).setRowData( rowid, { attr4_code: rs["04_code"] } );
										$( "#bomList1" ).setRowData( rowid, { attr5_code: rs["05_code"] } );
										$( "#bomList1" ).setRowData( rowid, { attr6_code: rs["06_code"] } );
										$( "#bomList1" ).setRowData( rowid, { attr7_code: rs["07_code"] } );
										$( "#bomList1" ).setRowData( rowid, { attr8_code: rs["08_code"] } );
										$( "#bomList1" ).setRowData( rowid, { attr9_code: rs["09_code"] } );
										$( "#bomList1" ).setRowData( rowid, { attr10_code: rs["10_code"] } );
										$( "#bomList1" ).setRowData( rowid, { attr11_code: rs["11_code"] } );
										$( "#bomList1" ).setRowData( rowid, { attr12_code: rs["12_code"] } );
										$( "#bomList1" ).setRowData( rowid, { attr13_code: rs["13_code"] } );
										$( "#bomList1" ).setRowData( rowid, { attr14_code: rs["14_code"] } );
										$( "#bomList1" ).setRowData( rowid, { attr15_code: rs["15_code"] } );
										
										$( "#bomList1" ).setRowData( rowid, { add_attr1: rs["add_01"] } );
										$( "#bomList1" ).setRowData( rowid, { add_attr2: rs["add_02"] } );
										$( "#bomList1" ).setRowData( rowid, { add_attr3: rs["add_03"] } );
										$( "#bomList1" ).setRowData( rowid, { add_attr4: rs["add_04"] } );
										$( "#bomList1" ).setRowData( rowid, { add_attr5: rs["add_05"] } );
										$( "#bomList1" ).setRowData( rowid, { add_attr6: rs["add_06"] } );
										$( "#bomList1" ).setRowData( rowid, { add_attr7: rs["add_07"] } );
										$( "#bomList1" ).setRowData( rowid, { add_attr8: rs["add_08"] } );
										$( "#bomList1" ).setRowData( rowid, { add_attr9: rs["add_09"] } );
										$( "#bomList1" ).setRowData( rowid, { add_attr10: rs["add_10"] } );
										$( "#bomList1" ).setRowData( rowid, { add_attr11: rs["add_11"] } );
										$( "#bomList1" ).setRowData( rowid, { add_attr12: rs["add_12"] } );
										$( "#bomList1" ).setRowData( rowid, { add_attr13: rs["add_13"] } );
										$( "#bomList1" ).setRowData( rowid, { add_attr14: rs["add_14"] } );
										$( "#bomList1" ).setRowData( rowid, { add_attr15: rs["add_15"] } );
										$( "#bomList1" ).setRowData( rowid, { weight: rs["weight"] } );
										
										
										$( "#bomList1" ).setRowData( rowid, { item_attr: '입력 완료' } );
										$( '#bomList1' ).jqGrid( 'setCell', rowid, 'item_attr','', {background : '#FF7E9D' } );
									}
								}
								...
								if(colName['index'] == "bom_attr"){
									...
									var rs = window.showModalDialog( "popUpBomItemDetail.do",
											param,
									"dialogWidth:500px; dialogHeight:550px; center:on; scroll:off; status:off" );
									if ( rs != null ) {
										var item = $( '#bomList1' ).jqGrid( 'getRowData', rowid );
										$( "#bomList1" ).setRowData( rowid, { bom1: rs[0] } );
										$( "#bomList1" ).setRowData( rowid, { bom2: rs[1] } );
										$( "#bomList1" ).setRowData( rowid, { bom3: rs[2] } );
										$( "#bomList1" ).setRowData( rowid, { bom4: rs[3] } );
										$( "#bomList1" ).setRowData( rowid, { bom5: rs[4] } );
										$( "#bomList1" ).setRowData( rowid, { bom6: rs[5] } );
										$( "#bomList1" ).setRowData( rowid, { bom7: rs[6] } );
										$( "#bomList1" ).setRowData( rowid, { bom8: rs[7] } );
										$( "#bomList1" ).setRowData( rowid, { bom9: rs[8] } );
										$( "#bomList1" ).setRowData( rowid, { bom10: rs[9] } );
										$( "#bomList1" ).setRowData( rowid, { bom11: rs[10] } );
										$( "#bomList1" ).setRowData( rowid, { bom12: rs[11] } );
										$( "#bomList1" ).setRowData( rowid, { bom13: rs[12] } );
										$( "#bomList1" ).setRowData( rowid, { bom14: rs[13] } );
										$( "#bomList1" ).setRowData( rowid, { bom15: rs[14] } );
										$( "#bomList1" ).setRowData( rowid, { qty: rs[15] } );
										
										if ( item.oper == 'I' ) {
											$( "#bomList1" ).setRowData( rowid, { bom_attr: '입력 완료' } );	
										} else {
											$( "#bomList1" ).setRowData( rowid, { oper : "U" } );
											$( "#bomList1" ).setRowData( rowid, { bom_attr: '편집 완료' } );
											$( "#bomList1" ).setRowData( rowid, { states_flag_desc : "변경" } );
											setSaveButtonEnabled();
										}
										$( '#bomList1' ).jqGrid( 'setCell', rowid, 'bom_attr','', {background : '#FF7E9D' } );
									}
								}
								
								
								if(colName['index'] == "history"){
									window.showModalDialog( "popUpBomItemHistory.do?project_no="+$("#p_project_no").val()+"&mother_code="+item.mother_code+"&item_code="+item.item_code,
											window,
						...
						gridComplete : function() {
							...
							for ( var i = 0; i < rows.length; i++ ) {
								...
								if( oper == "I" ) {
									$( "#bomList1" ).jqGrid( 'setCell', rows[i], 'item_catalog', '', { cursor : 'pointer', background : 'pink' } );
									$( "#bomList1" ).jqGrid( 'setCell', rows[i], 'item_code', '', { cursor : 'pointer', background : 'pink' } );
								} else {
									$( "#bomList1" ).jqGrid( 'setCell', rows[i], 'item_code', '', 'not-editable-cell' );
									$( "#bomList1" ).jqGrid( 'setCell', rows[i], 'item_desc', '', 'not-editable-cell' );
								}
								$( "#bomList1" ).jqGrid( 'setCell', rows[i], 'dwg_no', '', { cursor : 'pointer', background : 'pink' } );
							}
							$("#bomList1 td:contains('보기')").css("background","#ffff80").css("cursor","pointer");
							$("#bomList1 td:contains('편집')").css("background","pink").css("cursor","pointer");
							$("#bomList1 td:contains('입력')").css("background","pink").css("cursor","pointer");
				        	...
				        	if(name == "item_code"){
			        			...
			        			$.post("searchItemList.do", formData, function(data) {
			        				if(data.records != '1') {
			        					...
			        					$( "#bomList1" ).setRowData( id, { item_code: "" } );
			        				}
			        			}, "json").error(function() {
									alert("시스템 오류입니다.\n전산담당자에게 문의해주세요.");
								});
					...
					$("#treegrid2").jqGrid({
						...
						mtype: "",
						postData : fn_getFormData("#application_form"),
						colNames : [ 'LV', 'RLV', 'ITEM CODE', 'MOTHER CODE',
						             'BOM TYPE', 'CATALOG', 'DESCRIPTION', 'UOM', 'QTY', 'DWG No', 'Creator', 'ECO NO', 'ECO Creator', 'Item 속성', 'BOM 속성', 'History', 'LEAF', 'FOLD', 'BOM10', 'BOM11', "상태",'현황','select ID'],
						colModel : [ { name : 'lev', index : 'lev', width : 80, align : "left", hidden : true },
						             { name : 'rlev', index : 'rlev', width : 80, align : "left", hidden : true },
						             { name : 'item_code', index : 'item_code', width: 400, align : "left", sortable : false},
						             { name : 'mother_code', index : 'mother_code', width : 100, align : "left", hidden : true, sortable : false },
						             { name : 'bom_type', index : 'bom_type', width : 80, align : "center", hidden : true }, 
						             { name : 'item_catalog', index : 'item_catalog', width : 80, align : "center", hidden : true },
						             { name : 'item_desc', index : 'item_desc', width : 255, align : "left", hidden : true }, 
						             { name : 'uom', index : 'uom', width : 40, align : "center", hidden : true }, 
						             { name : 'qty', index : 'qty', width : 40, align : "right", hidden : true },
						             { name : 'dwg_no', index : 'dwg_no', width : 80, align : "center", editable : true , hidden : true},
						             { name : 'emp_no', index : 'emp_no', width : 150, align : "center", hidden : true }, 
						             { name : 'eco_no', index : 'eco_no', width : 80, align : "center", hidden : true }, 
						             { name : 'created_by', index : 'created_by', width : 150, align : "center", hidden : true },
						             { name : 'item_attr', index : 'item_attr', width : 70, align : "center", classes : "handcursor", hidden : true },
						             { name : 'bom_attr', index : 'bom_attr', width : 70, align : "center", classes : "handcursor", hidden : true },
						             { name : 'history', index : 'history', width : 70, align : "center", classes : "handcursor", hidden : true },
						             { name : 'leaf', index : 'leaf', width : 80, align : "left", hidden : true },
						             { name : 'fold', index : 'fold', width : 80, align : "left", hidden : true },
						             { name : 'bom10', index : 'bom10', width : 80, align : "left", hidden : true },
						             { name : 'bom11', index : 'bom11', width : 80, align : "left", hidden : true },
						             { name : 'item_states_desc', index : 'item_states_desc', width : 100, align : "left" , hidden : true},
						             { name : 'states_flag_desc', index : 'states_flag_desc', width : 40, align: "center", hidden : true},
						             { name : 'select_id', index : 'select_id', width : 40, align: "center", hidden : true, key : true }
						           ],
					   	autowidth : true,
						...
						onCellSelect : function( rowid, iCol, cellcontent, e ) {
							...
							if(item.states_flag_desc == "BOM" || $("#selectMotherCode").html() =="PROJECT" || item.bom_type == "PAINT_USC"){
								setButtonEnabled();
					...
					$("#btn_project_no").click(function() {
						...
						var rs = window.showModalDialog("popUpProjectNo.do?p_delegate_project_no=none", window, "dialogWidth:400px; dialogHeight:400px; center:on; scroll:off; status:off");
					...
					$("#btnManageSpecificStructure").click(
							function() {
								...
								var rs = window.showModalDialog("popUpManageSpecificStructure.do?sd_type=SPST_SHIP_TYPE",
										window, "dialogWidth:1300px; dialogHeight:680px; center:on; scroll:off; states:off");
							});
						...
						if(selrow != null) {
							...
							if (item.oper == 'I') {
								...
								for( var i in colModel ) {
									$( '#bomList1' ).jqGrid( 'setCell', selrow, colModel[i].name,'', {background : '#FF7E9D' } );
								}
								setSaveButtonEnabled();
							}
					...
					//Add 버튼 
					$("#btnAddSSC").click(function() {
						var arg = "&p_item_type_cd=PA&p_dwg_no=M2020000&p_project_no="+$( "#p_project_no").val()+"&p_job_cd="+$("#selectItemCode").html();
						var rs = window.open("sscAddMain.do?menu_id=${menu_id}&up_link=bom&newWin=Y"+ arg, "",
					...
					$("#btnHistory").click(function() {
						window.showModalDialog( "popUpBomItemHistory.do?project_no="+$("#p_project_no").val()+"&mother_code="+$("#selectMotherCode").html()+"&item_code="+$("#selectItemCode").html(),
								window,
								"dialogWidth:800px; dialogHeight:600px; center:on; scroll:off; status:off" );
					});
					//조회 버튼
					$("#btnSelect").click(function() {
						...
						var args = "?p_project_no="+$('#p_project_no').val()+
									...
									"&p_item_catalog="+$('#p_item_catalog').val()+
									"&p_emp_no="+$('#p_emp_no').val()+
									"&p_item_attr1="+$('#p_item_attr1').val()+
									"&p_item_attr2="+$('#p_item_attr2').val()+
									"&p_item_attr3="+$('#p_item_attr3').val()+
									"&p_eco_no="+$('#p_eco_no').val()+
									"&p_eco_emp_no="+$('#p_eco_emp_no').val();
					...
					$("#btnEcoReasonCode").click(function() {
						var rs = window.showModalDialog("popUpCause.do", window, "dialogWidth:700px; dialogHeight:700px; center:on; scroll:off; status:off");
						if (rs != null) {
					...
					$("#btnEmpNo").click(
							function() {
								var rs = window.showModalDialog("popUpEmpNoAndRegiter.do?register_type=RME&main_type=ECO", window,
					...
					$( "#btn_popup_dwg_dept" ).click( function () {
						var rs = window.showModalDialog( "popUpDpsDept.do",
								window,
						...
						var dialog = $( '<p>ECO를 연결합니다.</p>' ).dialog( {
							buttons : {
								"조회" : function() {
									...
									if( rs != null ) {
										$( "#p_eng_change_order_code" ).val( rs[0] );
									}
				...
				getSelectChmResultData(function(data) {
					...
					$.post(url, parameters, function(data) {
						...
						if ( data.result == 'success' ) {
							...
							if(item.states_flag_desc == "BOM" || $("#selectMotherCode").html() =="PROJECT" || $("#item_bom_type").val() == "PAINT_USC"){
								setButtonEnabled();
								setSaveButtonDisabled();
								setCreateButtonDisabled();
								fn_buttonDisabled([ "#btnAddSSC" ]);
		...
		function fn_popup_catalog_search( catalog_type, search_locate, rowid ) {
			...
			var rs = window.showModalDialog( "popUpCatalogSearch.do?catalog_type=" + catalog_type + "&p_catalog_code=" + p_catalog_code,
					window,
			...
			if ( rs != null ) {
				...
				if( catalog_type == "PD" ) {
					$( "#bomList1" ).setRowData( rowid, { pd_catalog: rs[0] } );
				} else if( catalog_type == "OUT1" ) {
					$( "#bomList1" ).setRowData( rowid, { activity_catalog : rs[0] } );
				} else if( catalog_type == "OUT2" ) {
					if($("#p_job_catalog").val() == rs[0]){
						alert("상위 CATALOG는 Job Type이 단일입니다.\n상위 CATALOG와 같은 CATALOG를 입력할 수 없습니다.\n다른 CATALOG를 선택해 주세요.");
						return;
					} else {
						$( "#bomList1" ).setRowData( rowid, { item_catalog : rs[0] } );
						$( "#bomList1" ).setRowData( rowid, { item_desc : rs[1] } );
					}
				}
		...
		function getChangedChmResultData(callback) {
			var changedData = $.grep($("#bomList1").jqGrid('getRowData'),
					function(obj) {

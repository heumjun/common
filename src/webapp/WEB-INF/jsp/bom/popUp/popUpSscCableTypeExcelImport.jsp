...
<script type="text/javascript" >
	$(document).ready(function(){
		...
		(function() {
			...
			var url = "sscCableTypeExcelImportAction.do?p_master_no="+master+"&p_dwg_no="+dwgno+"&p_item_type_cd="+item_type_cd+"&p_series_cnt="+seriesCnt+"&p_limit_cnt="+limitCnt;
	...
	var callback = function(json){
		...
		for(var i=0; i<json.rows.length; i++){
			var rows = json.rows[i];
				...
				jsonGridData.push({ type_abbr : rows.column0
								 , type_spec : rows.column1
					             , type_type : rows.column2
					             , type_weight : rows.column3
					             , type_area : rows.column4
					             , out_dia : rows.column5
					             , drum_len : rows.column7
					             , uom : rows.column8
					             , bind_group : rows.column10
					             , oper : 'I'});
		}

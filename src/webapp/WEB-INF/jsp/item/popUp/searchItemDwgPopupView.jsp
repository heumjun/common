...
<input type="hidden" id="p_item_code" name="p_item_code" value="<c:out value="${p_item_code}" />" />
...
$(document).ready(function(){
	...
	var vReturn = getDWGXML("searchItemDwgPopupViewList.do?VIEWMODE="+mode+"&p_item_code="+p_item_code+"&vEmpNo="+user_id);

...
$(document).ready(function(){
	...
	$("#paintItemList").jqGrid({ 
             ...
             url		: '',
             postData   : '',
             colNames   : ['Quay','Area Code','Area Name','Count','Paint Code','Paint Desc'
             				,'DFT','Area','Quantity','Theory Qty','Stage','TSR','S/W',''],
             colModel	: [
		                	{name:'zone_code', 			index:'zone_code',  		width:50, 	sortable:false},
		                	...
		                	{name:'paint_item',			index:'paint_item', 		width:140, 	sortable:false},
		             		...
		             		{name:'theory_quantity', 	index:'theory_quantity',  	width:70, 	sortable:false, align:'right'},
		                	{name:'paint_stage', 		index:'stage',  			width:50, 	sortable:false, align:'center'},
		                	{name:'paint_tsr', 			index:'tsr',  				width:50, 	sortable:false, align:'center'},
...
function fn_search(){
	...
	var sUrl = "selectQuayPaintPlanList.do";

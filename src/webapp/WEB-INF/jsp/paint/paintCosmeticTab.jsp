	...
	$("#paintItemList").jqGrid({ 
             ...
             colModel	: [
		                	...
		                	{name:'item_desc',			index:'item_desc', 			width:320, 	sortable:false},
		             		{name:'quantity', 			index:'quantity',  			width:100, 	sortable:false, align:'right', editable:true, editrules:{required:true,number:true}},
		             		{name:'theory_quantity', 	index:'theory_quantity',  	width:100, 	sortable:false, align:'right', hidden:true},
...
function fn_search(){
	...
	var sUrl = "selectCosmeticList.do";

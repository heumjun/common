...
$(document).ready(function(){
	...
	$("#paintItemList").jqGrid({ 
             ...
             url		: '',
             postData   : '',
             colNames   : ['PE','제작처','S/P Area','Paint Area',''],
             colModel	: [
		                	{name:'pe_code', 			index:'pe_code',  			width:50, 	sortable:false},
		                	{name:'make_name',			index:'make_name', 			width:80, 	sortable:false, align:'left'},
		                	{name:'sp_area',			index:'sp_area', 			width:120, 	sortable:false, align:'right'},
		                	{name:'paint_area', 		index:'paint_area',  		width:120, 	sortable:false, align:'right'},
...
function fn_search() {
	...
	var sUrl = "selectPEPaintAreaList.do";

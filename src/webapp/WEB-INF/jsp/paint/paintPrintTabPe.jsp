...
$(document).ready(function(){
	...
	$("#paintItemList").jqGrid({ 
             ...
             url		: '',
             postData   : '',
             colNames   : ['PE','Area Code','Area Name','Count','Paint Code','Paint Desc'
             				,'DFT','Area','Quantity','Theory Qty','Stage','TSR','S/W',''],
             colModel	: [
		                	{name:'pe_code', 			index:'pe_code',  			width:50, 	sortable:false},
...
function fn_search(){
	...
	var sUrl = "selectPEPaintPlanList.do";

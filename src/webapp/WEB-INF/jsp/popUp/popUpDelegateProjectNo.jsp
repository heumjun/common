...
<html>
	...
	<body>
		<form id="application_form" name="application_form">
			<input type="hidden" name="sType" id="sType" value="select_delegate_project_no" />
			...
			<div class = "topMain" style="margin-top: 0px;line-height: 45px;">
				<div class="conSearch">
					...
					<strong>호선명</strong>
					<input type="text" class="w100h25" id="p_delegate_project_no" name="p_delegate_project_no" style="text-transform: uppercase;" />
		...
		$(document).ready( function() {
			...
			$( "#delegateProjectNoList" ).jqGrid( {
				mtype : 'POST',
				url:'infoDelegateProjectNoList.do',
				datatype: "json",
				postData : fn_getFormData("#application_form"),
				colNames : [ '대표호선' ],
				colModel : [ { name : 'delegate_project_no', index : 'delegate_project_no', width : 40, align : "left" } ],
			   	rowNum : -1,
...
// 			    sortorder: "desc",
				...
				ondblClickRow : function( rowid, iRow, iCol, e ) {
					...
					var delegate_project_no = rowData['delegate_project_no'];

					var returnValue = new Array();
					returnValue[0] = delegate_project_no;
		...
		function fn_search() {
			var sUrl = "infoDelegateProjectNoList.do";

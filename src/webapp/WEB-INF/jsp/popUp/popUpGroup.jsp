		...
		<form id="application_form" name="application_form">
			...
			<div class="topMain" style="margin: 0px;line-height: 45px;">
				<div class="conSearch">
					...
					<!-- &nbsp;&nbsp;<strong>기간</strong>
					<input type="text" id="created_date_start" name="created_date_start" class="datepicker h25" style="width:70px;" />
					~
					<input type="text" id="created_date_end" name="created_date_end" class="datepicker h25" style="width:70px;" /> -->
				</div>
				<div class="button">

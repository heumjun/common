...
<script type="text/javascript" >
	...
	var callback = function(json){
		...
		for(var i=0; i<json.rows.length; i++){
			...
			jsonGridData.push({model_type : rows.column0
				             , construct_type : rows.column1
				             , block_no : rows.column2
				             , area : rows.column3
				             , block_catalog : rows.column4
				             , block_str_flag : rows.column5
				             , upper_block : rows.column6
				             , virtual_yn : rows.column7
				             , activity_catalog : rows.column8
				             , job_catalog : rows.column9
				             , str_flag : rows.column10
				             , usc_job_type : rows.column11
				             , work_yn : rows.column12
				             , activity_area : rows.column13
				             , activity_type : rows.column14
				             , description : rows.column15
				             , use_yn : rows.column16
				             , use_yn_changed : rows.column16
				             , remark : rows.column17
				             , oper : 'I'});			
		}

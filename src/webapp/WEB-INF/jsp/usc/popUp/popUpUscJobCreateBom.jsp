	...
	$(document).ready(function(){
		jqGridObj.jqGrid({ 
			...
			colModel : [
					...
					{label:'B_STR'		, name : 'block_str_flag'		, index : 'block_str_flag'			, width : 60, editable : false, align : "center"},
					...
					{label:'MOVE ACT ITEM', name : 'old_act_code'			, index : 'old_act_code'			, width : 100, editable : false, align : "center"},
					{label:'JOB TYPE'	, name : 'usc_job_type'			, index : 'usc_job_type'			, width : 100, editable : false, align : "center"},
					{label:'JOB ITEM'	, name : 'job_code'				, index : 'job_code'				, width : 100, editable : false, align : "center"},
					{label:''			, name : 'act_catalog'			, index : 'act_catalog'				, width : 100, editable : false, align : "center", hidden:true},
					{label:''			, name : 'job_catalog'			, index : 'job_catalog'				, width : 100, editable : false, align : "center", hidden:false},
					{label:'WORK DATE'	, name : 'work_date'			, index : 'work_date'				, width : 100, editable : false, align : "center", hidden:true},
					{label:'WORK'		, name : 'work_yn'				, index : 'work_yn'					, width : 60, editable : false, align : "center", hidden:true},
					{label:'ACT CODE'	, name : 'wip_act_code'			, index : 'wip_act_code'			, width : 100, editable : false, align : "center", hidden:true},
			...
			if(uniqeValidation()){
				...
				if(confirm("적용 하시겠습니까?")) {
					...
					getChangedChmResultData( function( data ) {
						...
						var url = 'saveUscJobCreateEco.do';

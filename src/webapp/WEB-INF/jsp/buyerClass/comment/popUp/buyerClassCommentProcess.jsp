...
§FILENAME: stxPECBuyerClassCommentProcess.jsp
§CHANGING HISTORY: 
...
/***
System.out.println("####### stxPECBuyerClassCommentProcess.jsp");
...
<div class="subtitle">
	실적 등록 <span class="guide"><img src="./images/content/yellow.gif" />&nbsp;필수입력사항</span>
</div>
...
<script language="JavaScript">
	...
	function designProcessAction()
	{
        ...
        if(mainForm.comment_count.value < mainForm.reply_count.value){
        	alert("Reply는 Comment수를 넘을 수 없습니다.");
        	return;
        }
		...
		if(file_regEx.test(fileName) == true){
        ...
        if(confirm("실적 등록을 진행하시겠습니까?"))
        {
            ...
            mainForm.action = "buyerClassCommentProcessAction.do";

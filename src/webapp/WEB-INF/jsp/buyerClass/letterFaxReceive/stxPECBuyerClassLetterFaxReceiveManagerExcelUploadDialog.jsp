...
<script language="javascript">
	function checkInput()
	{
		...
		document.importForm.action = "AddOn/DP/stxPECBuyerClassLetterFaxReceiveManagerExcelUploadToDB.jsp";
	...
	function clearFile(){
		...
		document.importForm.action = "b.do";
		document.importForm.target = "UpdateLower";
		document.importForm.submit();
...
<form name="importForm" method="post" action="AddOn/DP/stxPECBuyerClassLetterFaxReceiveManagerExcelUploadToDB.jsp" target="" onsubmit=""  enctype="multipart/form-data">

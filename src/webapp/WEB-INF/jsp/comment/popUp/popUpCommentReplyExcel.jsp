...
function getMainGridColModel(){
	...
	gridColModel.push({label:'BUILDER\'S REPLY' ,name:'builders_reply' , index:'builders_reply' ,width:400 ,align:'left', sortable:false, title:false, editable:true});
	gridColModel.push({label:'Ref No.' ,name:'send_no' , index:'send_no' ,width:60 ,align:'center', sortable:false, title:false, editable:true});
	gridColModel.push({label:'Send Id' ,name:'send_id' , index:'send_id' ,width:60 ,align:'center', sortable:false, title:false, editable:true, hidden: true});
...
$(document).ready(function(){
	...
	jqGridObj.jqGrid('setLabel','send_no', '', {'background':'#CCC0DA'});
	jqGridObj.jqGrid('setLabel','upload_result', '', {'background':'#CCC0DA'});
	...
	$("#btnSave").click(function() {
		...
		if(confirm("오류항목 제외하고 저장하시겠습니까?\n확인: 항목만 저장, 취소: 현재창 유지")){
			...
			var url			= "commentReplyImportConfirmProc.do";
	...
	$("#btnExlImp").click(function(){
		...
		var sURL = "popUpCommentReplyExcelImport.do";

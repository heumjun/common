...
<title>Comment Reply Excel Import</title>
...
<script type="text/javascript" >
	$(document).ready(function(){
		...
		(function() {
			...
			var url = "commentReplyExcelImportAction.do?p_project_no=" + projectNo + "&p_dwg_no=" + dwgNo + "&p_issuer=" + issuer;
	...
	var callback = function(json) {
		...
		for(var i=0; i<json.rows.length; i++){
			...
			jsonGridData.push({receipt_no : rows.receipt_no
				             ...
				             , builders_reply : rows.builders_reply
				             , send_no : rows.send_no

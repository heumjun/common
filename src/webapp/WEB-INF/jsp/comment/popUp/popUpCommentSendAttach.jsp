...
$(function() {
	$("#fileName").uploadify({
		...
		onUploadSuccess : function(file, data, response) {  
			...
			args.jqGridObj.setCell(rowid, 'doc_cnt', "첨부");
			...
			if(args.jqGridObj.getCell(rowid, 'oper') == '') {
				...
				args.fn_buttonDisabled2([ "#btnRequest" ]);
			}
         },
...
$(document).ready(function(){
	...
	jqGridObj.jqGrid({ 
		datatype: 'json', 
		mtype: 'POST', 
		url:'popUpCommentSendAttachList.do',
...
function fileDelFormatter(cellvalue, options, rowObject ) {
	return "<a href=\"#none\" style=\"cursor:pointer;vertical-align:middle;\" onclick=\"fileDelete('"+rowObject.document_id+"');\">" + cellvalue + "</a>";			
}
...
function fn_search() {
	var sUrl = "popUpCommentSendAttachList.do";

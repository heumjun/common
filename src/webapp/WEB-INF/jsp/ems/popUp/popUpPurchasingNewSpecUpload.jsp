...
<html xmlns="http://www.w3.org/1999/xhtml" >
	...
	<body>
		<form id="application_form" name="application_form" action="popUpPurchasingNewSpecUploadFile.do" method="post" enctype="multipart/form-data">
			...
			<div style="height: 200px; overflow: scroll; overflow-x: hidden; overflow-y:visible; ">
				<table class = "searchArea2">
					<colgroup>
						<col width="10%"/>
						<col width="*"/>
		...
		<script type="text/javascript" >
			...
			$(document).ready(function(){
				...
				$("#btnAdd").click(function(){
					...
					$("#example").append("<tr><td style=\"font-weight: bold;\">"+rowCnt+"</td><td><input type=\"file\" id=\"p_tech_spec_"+(rowCnt-1)+"\" name=\"p_tech_spec_"+(rowCnt-1)+"\" /></td></tr>");
				});	

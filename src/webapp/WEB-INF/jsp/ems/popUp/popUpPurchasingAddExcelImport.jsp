...
<body>
<form id="application_form" name="application_form" action="popUpPurchasingAddExcelList.do" method="post" enctype="multipart/form-data">	
	<input type="hidden" name="p_daoName" value="EMS_PURCHASING" />
	<input type="hidden" name="p_queryType" value="select" />
	<input type="hidden" name="p_process" value="selectPurchasingExcelImport" />
	<input type="hidden" name="p_ship_kind" value="${p_ship_kind}" />

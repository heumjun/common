...
<input type="hidden" id="p_pgm_id" name="p_pgm_id" value="${p_pgm_id}" />
<input type="hidden" id="p_option" name="p_option" value="${p_option}" />


	<div class="subtitle">Manual File Upload</div>	
	...
	<div class = "topMain" style="margin-top: 0px;">
		<table class="searchArea2 conSearch">
			...
			<col width="460"/>
				<tr>
					<th class="only_eco">Rev. <br>Description</th>
					<td>
						<textarea name="revision_desc" id= "revision_desc" rows="3" style="width:95%; margin-top:10px;"></textarea>
					</td>
				</tr>
				<tr>
...
$(document).ready(function(){
	...
	$("#btnExlUp").click(function(){
        ...
        if(confirm("저장하시겠습니까?"))
        {
            ...
            //frm.target = "_self";
            frm.action = "manualAddSave.do?p_pgm_id"+$("#p_pgm_id").val();
            
            var file = $("#fileExl").val().toLowerCase();
            if($("#p_option").val() == 'MANUAL') {
            	if(!isPdfFile(file)){
    				return false;	
    			}	
            } else {

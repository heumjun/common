...
$(document).ready(function(){
	...
	$("#btn_save").click(function(){
		...
		var url = '<c:url value="dataMgmtOldMainGridSave.do"/>';
	...
	$("#btn_search").click(function(){
		var sUrl = 'dataMgmtOldMainGrid.do';
	...
	$("#btn_excel").click(function(){
		var sUrl = "dataMgmtOldExcelExport.do";
...
$(document).ready( function() {
	...
	$( "#dataList" ).jqGrid( {
		...
		colNames : ['PROJECT','작업일자','사번','성명','부서CODE','부서','도면번호','OP코드',
		            '원인부서','정상','잔업','특근','E1','E2','E3','start_time','oper'],
		colModel : [{name : 'project_no', index : 'project_no', width: 10, align : "center"},
		            ...
		            {name : 'dept_name', index : 'dept_name', width: 25, align : "left"},
		            {name : 'dwg_code', index : 'dwg_code', width: 10, align : "center"},
		            {name : 'op_code', index : 'op_code', width: 10, align : "center"},
		            {name : 'cause_depart', index : 'cause_depart', width: 10, align : "center"},
		            {name : 'normal_time_factor', index : 'normal_time_factor', width: 10, align : "center"},
		            {name : 'over_time_factor', index : 'over_time_factor', width: 10, align : "center"},
		            {name : 'special_time_factor', index : 'special_time_factor', width: 10, align : "center"},
		            {name : 'event1', index : 'event1', width: 5, align : "center"},
		            {name : 'event2', index : 'event2', width: 5, align : "center"},
		            {name : 'event3', index : 'event3', width: 5, align : "center"},
		            {name : 'start_time', index : 'start_time', width: 10, align : "center", hidden:true},

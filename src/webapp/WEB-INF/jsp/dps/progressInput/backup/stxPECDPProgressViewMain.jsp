...
<%!
	                                      ...
	                                      String dateCondition, String[] drawingNoArray, String drawingTitle) throws Exception
	{
		...
		try {
			...
			queryStr.append("      (SELECT ACTIVITYDESC FROM APS_ACTIVITY_LIST_V WHERE PROJECTNO = WK.PROJECTNO AND ACTIVITYCODE = WK.REFEVENT2 AND ROWNUM = 1) AS NEW_ACTIVITY_DESC1,                         ");
			queryStr.append("      CASE WHEN WK.OLD_REFEVENT IS NOT NULL THEN (SELECT ACTIVITYDESC FROM APS_ACTIVITY_LIST_V WHERE PROJECTNO = WK.PROJECTNO AND ACTIVITYCODE = WK.OLD_REFEVENT AND ROWNUM = 1)  ");
			queryStr.append("           ELSE (SELECT ACTIVITYDESC FROM APS_ACTIVITY_LIST_V WHERE PROJECTNO = WK.PROJECTNO AND ACTIVITYCODE = WK.REFEVENT2 AND ROWNUM = 1) END AS OLD_ACTIVITY_DESC1,           ");
			queryStr.append("      TO_CHAR(WK.REFDATE,'YYYY-MM-DD') AS NEW_ACTIVITY_DESC2,                                                                                                                     ");
			queryStr.append("      CASE WHEN WK.OLD_REFEVENT IS NOT NULL THEN TO_CHAR(WK.OLD_REFDATE, 'YYYY-MM-DD')                                                                                            ");
			queryStr.append("           ELSE TO_CHAR(WK.REFDATE,'YYYY-MM-DD') END AS OLD_ACTIVITY_DESC2,                                                                                                       ");
			...
			queryStr.append("            AND A.DWG_NO     = SUBSTR(DW.ACTIVITYCODE, 1, 8)                                               ");
			queryStr.append("        ) AS SUM_BOM_QTY                                                                                   ");
			...
			/* (SELECT E.DWGDEPTCODE FROM DCC_DEPTCODE E WHERE E.DEPTCODE='" + deptCode + "') */
			...
			while (rset.next()) {
				...
				resultMap.put("NEW_ACTIVITY_DESC1", rset.getString(47) == null ? "" : rset.getString(47));
				resultMap.put("OLD_ACTIVITY_DESC1", rset.getString(48) == null ? "" : rset.getString(48));
				resultMap.put("NEW_ACTIVITY_DESC2", rset.getString(49) == null ? "" : rset.getString(49));
				resultMap.put("OLD_ACTIVITY_DESC2", rset.getString(50) == null ? "" : rset.getString(50));
				resultMap.put("DIFF_DATE", rset.getString(51) == null ? "" : rset.getString(51));
                resultMap.put("DW_ATTRIBUTE4", rset.getString(52) == null ? "" : rset.getString(52));
                resultMap.put("DW_ATTRIBUTE5", rset.getString(53) == null ? "" : rset.getString(53));
                resultMap.put("OW_ATTRIBUTE4", rset.getString(54) == null ? "" : rset.getString(54));
                resultMap.put("OW_ATTRIBUTE5", rset.getString(55) == null ? "" : rset.getString(55));
                resultMap.put("CL_ATTRIBUTE4", rset.getString(56) == null ? "" : rset.getString(56));
                resultMap.put("CL_ATTRIBUTE5", rset.getString(57) == null ? "" : rset.getString(57));
                resultMap.put("RF_ATTRIBUTE4", rset.getString(58) == null ? "" : rset.getString(58));
                resultMap.put("RF_ATTRIBUTE5", rset.getString(59) == null ? "" : rset.getString(59));
                resultMap.put("WK_ATTRIBUTE4", rset.getString(60) == null ? "" : rset.getString(60));
                resultMap.put("WK_ATTRIBUTE5", rset.getString(61) == null ? "" : rset.getString(61));                
                resultMap.put("SUB_SABUN", rset.getString(62) == null ? "" : rset.getString(62));
                resultMap.put("SUB_NAME", rset.getString(63) == null ? "" : rset.getString(63));                
                resultMap.put("SUM_BOM_QTY", rset.getString(64) == null ? "" : rset.getString(64));               
...
<%
    ...
    String projectNo = StringUtil.setEmptyExt(request.getParameter("projectNo"));
    String deptCode = StringUtil.setEmptyExt(request.getParameter("deptCode"));
    String designerID = StringUtil.setEmptyExt(request.getParameter("designerID"));
    String dateFrom = StringUtil.setEmptyExt(request.getParameter("dateFrom"));
    String dateTo = StringUtil.setEmptyExt(request.getParameter("dateTo"));
    String dateCondition = StringUtil.setEmptyExt(request.getParameter("dateCondition"));
    String drawingNo1 = StringUtil.setEmptyExt(request.getParameter("drawingNo1"));
    String drawingNo2 = StringUtil.setEmptyExt(request.getParameter("drawingNo2"));
    String drawingNo3 = StringUtil.setEmptyExt(request.getParameter("drawingNo3"));
    String drawingNo4 = StringUtil.setEmptyExt(request.getParameter("drawingNo4"));
    String drawingNo5 = StringUtil.setEmptyExt(request.getParameter("drawingNo5"));
    String drawingNo6 = StringUtil.setEmptyExt(request.getParameter("drawingNo6"));
    String drawingNo7 = StringUtil.setEmptyExt(request.getParameter("drawingNo7"));
    String drawingNo8 = StringUtil.setEmptyExt(request.getParameter("drawingNo8"));
    //String drawingNo9 = StringUtil.setEmptyExt(request.getParameter("drawingNo9"));
    //String drawingNo10 = StringUtil.setEmptyExt(request.getParameter("drawingNo10"));
    String drawingTitle = StringUtil.setEmptyExt(request.getParameter("drawingTitle"));
    String showMsg = StringUtil.setEmptyExt(request.getParameter("showMsg"));
    String isManager = StringUtil.setEmptyExt(request.getParameter("isManager"));
    String isAdmin = StringUtil.setEmptyExt(request.getParameter("isAdmin"));
    String userDept = StringUtil.setEmptyExt(request.getParameter("userDept"));
    String titleSize = StringUtil.setEmptyExt(request.getParameter("titleSize"));

    //20101224 kuni start - Table Data Sort
    String sortValue = StringUtil.setEmptyExt(request.getParameter("sortValue"));
    String sortType = StringUtil.setEmptyExt(request.getParameter("sortType"));
    String sortImage = "";
    //20101224 kuni end
    ...
    try {
        if (!projectNo.equals("")) {
            ...
            if(sortType==null || "".equals(sortType) || "descending".equals(sortType)){
            	sortType = "ascending";
            	sortImage = "<img src=\"AddOn/common/images/utilSortArrowUp.gif\" align=\"absmiddle\" border=\"0\" />";
            }else if("ascending".equals(sortType)){
            	sortType = "descending";
            	sortImage = "<img src=\"AddOn/common/images/utilSortArrowDown.gif\" align=\"absmiddle\" border=\"0\" />";
            }
    ...
    String c1Checked = StringUtil.setEmptyExt(request.getParameter("c1"));
    String c2Checked = StringUtil.setEmptyExt(request.getParameter("c2"));
    String c3Checked = StringUtil.setEmptyExt(request.getParameter("c3"));
    String c4Checked = StringUtil.setEmptyExt(request.getParameter("c4"));
    String c5Checked = StringUtil.setEmptyExt(request.getParameter("c5"));
    String c6Checked = StringUtil.setEmptyExt(request.getParameter("c6"));
    String c7Checked = StringUtil.setEmptyExt(request.getParameter("c7"));
    String c8Checked = StringUtil.setEmptyExt(request.getParameter("c8"));
    String c9Checked = StringUtil.setEmptyExt(request.getParameter("c9"));
    String c10Checked = StringUtil.setEmptyExt(request.getParameter("c10"));
    String c11Checked = StringUtil.setEmptyExt(request.getParameter("c11"));
    String c12Checked = StringUtil.setEmptyExt(request.getParameter("c12"));
    String c13Checked = StringUtil.setEmptyExt(request.getParameter("c13"));
    String c14Checked = StringUtil.setEmptyExt(request.getParameter("c14"));
    String c15Checked = StringUtil.setEmptyExt(request.getParameter("c15"));

    String c16Checked = StringUtil.setEmptyExt(request.getParameter("c16"));
    
    String c1Display = c1Checked.equalsIgnoreCase("True") ? "none" : "";
    String c2Display = c2Checked.equalsIgnoreCase("True") ? "none" : "";
    String c3Display = c3Checked.equalsIgnoreCase("True") ? "none" : "";
    String c4Display = c4Checked.equalsIgnoreCase("True") ? "none" : "";
    String c5Display = c5Checked.equalsIgnoreCase("True") ? "none" : "";
    String c6Display = c6Checked.equalsIgnoreCase("True") ? "none" : "";
    String c7Display = c7Checked.equalsIgnoreCase("True") ? "none" : "";
    String c8Display = c8Checked.equalsIgnoreCase("True") ? "none" : "";
    String c9Display = c9Checked.equalsIgnoreCase("True") ? "none" : "";
    String c10Display = c10Checked.equalsIgnoreCase("True") ? "none" : "";
    String c11Display = c11Checked.equalsIgnoreCase("True") ? "none" : "";
    String c12Display = c12Checked.equalsIgnoreCase("True") ? "none" : "";
    String c13Display = c13Checked.equalsIgnoreCase("True") ? "none" : "";
    String c14Display = c14Checked.equalsIgnoreCase("True") ? "none" : "";
    String c15Display = c15Checked.equalsIgnoreCase("True") ? "none" : "";

    String c16Display = c15Checked.equalsIgnoreCase("True") ? "none" : "";
...
<script language="javascript">
    ...
    { 
    %>
        parent.DPProgressViewHeader.keyeventCT.value = '<%=(String)keyEventMap.get("CT")%>';
        parent.DPProgressViewHeader.keyeventSC.value = '<%=(String)keyEventMap.get("SC")%>';
        parent.DPProgressViewHeader.keyeventKL.value = '<%=(String)keyEventMap.get("KL")%>';
        parent.DPProgressViewHeader.keyeventLC.value = '<%=(String)keyEventMap.get("LC")%>';
        parent.DPProgressViewHeader.keyeventDL.value = '<%=(String)keyEventMap.get("DL")%>';
        <%
    } 
    %>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" align="left">
    <tr valign="top">
        <td width="400px">
            <div id="header_left" style="margin-left:0px; width:400px; overflow:hidden" >
                <table class="insertArea" height='85px'>
                    <tr>
                        <th id="td_header_no" 				 style="min-width:24px">No</th>
                        <th id="td_header_project" 			 style="min-width:50px;display:<%=c1Display%>;cursor:hand;" onclick="viewDPProgress('PROJECTNO','<%="PROJECTNO".equals(sortValue)?sortType:""%>')">Project<%="PROJECTNO".equals(sortValue)?sortImage:""%> </th>
                        <th id="td_header_part" 			 style="min-width:90px;display:<%=c2Display%>;cursor:hand;" onclick="viewDPProgress('DEPTNAME','<%="DEPTNAME".equals(sortValue)?sortType:""%>')">Part<%="DEPTNAME".equals(sortValue)?sortImage:""%></th>
                        <th id="td_header_drawingno" 		 style="min-width:70px;display:<%=c3Display%>;cursor:hand;" onclick="viewDPProgress('DWGCODE','<%="DWGCODE".equals(sortValue)?sortType:""%>')">DrawingNo<%="DWGCODE".equals(sortValue)?sortImage:""%></th>
                        <th id="td_header_zone" 			 style="min-width:40px;display:<%=c4Display%>;cursor:hand;" onclick="viewDPProgress('DWGZONE','<%="DWGZONE".equals(sortValue)?sortType:""%>')">Zone<%="DWGZONE".equals(sortValue)?sortImage:""%></th>
                        <th id="td_header_outsourcingplan" 	 style="min-width:81px;display:<%=c5Display%>;cursor:hand;">Outsourcing<br>Plan</th>
                        <th id="td_header_task" 			 style="min-width:<%=iTitleW%>px;display:<%=c6Display%>;cursor:hand;" onclick="viewDPProgress('DWGTITLE','<%="DWGTITLE".equals(sortValue)?sortType:""%>')">Task(Drawing Title)<%="DWGTITLE".equals(sortValue)?sortImage:""%></th>
                        <th id="td_header_user" 			 style="min-width:50px;display:<%=c7Display%>;cursor:hand;" onclick="viewDPProgress('NAME','<%="NAME".equals(sortValue)?sortType:""%>')">1st<br>담당자<%="NAME".equals(sortValue)?sortImage:""%></th>                        
                        <th id="td_header_subuser" 			 style="min-width:50px;display:<%=c16Display%>;cursor:hand;" onclick="viewDPProgress('SUB_NAME','<%="SUB_NAME".equals(sortValue)?sortType:""%>')">2nd<br>담당자<%="SUB_NAME".equals(sortValue)?sortImage:""%></th>
                    </tr>
                </table>
            </div>
        </td>
        ...
        <td>
            <div id="header_right" style="margin-left:5px;width:1500px;overflow-y:scroll;overflow-x:hidden" >
                <table  class="insertArea" height='80px'>
                    <tr>
                        <th rowspan="3"  style="min-width:40px" style="cursor:hand;" onclick="viewDPProgress('MAX_REV','<%="MAX_REV".equals(sortValue)?sortType:""%>')">Rev.<%="MAX_REV".equals(sortValue)?sortImage:""%></th>
                        <th rowspan="3"  style="min-width:70px" style="cursor:hand;" onclick="viewDPProgress('DEPLOY_DATE','<%="DEPLOY_DATE".equals(sortValue)?sortType:""%>')">출도일자<%="DEPLOY_DATE".equals(sortValue)?sortImage:""%></th>
                        <th id="yardDrawingHeader1" colspan="2"  style="display:<%=c8Display%>;">DrawingStart</th>
                        <th id="yardDrawingHeader2" colspan="2"  style="display:<%=c9Display%>;">DrawingFinish</th>
                        <th id="yardDrawingHeader3" colspan="2"  style="display:<%=c10Display%>;">OwnerApp.Submit</th>
                        <th id="yardDrawingHeader4" colspan="2"  style="display:<%=c11Display%>;">OwnerApp.Receive</th>
                        <th id="yardDrawingHeader5" colspan="2"  style="display:<%=c12Display%>;">ClassApp.Submit</th>
                        <th id="yardDrawingHeader6" colspan="2"  style="display:<%=c13Display%>;">ClassApp.Receive</th>
                        <th id="yardDrawingHeader7" colspan="2"  style="display:<%=c14Display%>;">Working</th>
                        <th id="commonDrawingHeader1" rowspan="2" colspan="2"  style="display:<%=c15Display%>;">Construction</th>
                        <th colspan="2" rowspan="2" class="td_standardSmall" width="240" nowrap>참조EVENT</td>
                        <th colspan="3" rowspan="2" class="td_standardSmall" width="210" nowrap>현재일자</td>
                        <th colspan="8" class="td_standardSmall" width="420" nowrap>MANHOUR</td>
                        <th style="min-width:70px;" rowspan="3" class="td_standardSmall" width="70" nowrap>BOM 수량</td>
                    </tr>
                    <tr>
                        <th id="vendorDrawingHeader1" colspan="2"  style="display:<%=c8Display%>;">PurchaseRequest</th>
                        <th id="vendorDrawingHeader2" colspan="2"  style="display:<%=c9Display%>;">MakerSelection</th>
                        <th id="vendorDrawingHeader3" colspan="2"  style="display:<%=c10Display%>;">PurchaseOrder</th>
                        <th id="vendorDrawingHeader4" colspan="2"  style="display:<%=c11Display%>;">DrawingReceive</th>
                        <th id="vendorDrawingHeader5" colspan="2"  style="display:<%=c12Display%>;">OwnerApp.Submit</th>
                        <th id="vendorDrawingHeader6" colspan="2"  style="display:<%=c13Display%>;">OwnerApp.Receive</th>
                        <th id="vendorDrawingHeader7" colspan="2"  style="display:<%=c14Display%>;">MakerWorking</th>
                        <th colspan="2"  >Plan</th>
                        <th colspan="2"  >Internal</th>
                        <th colspan="2"  >Outsourcing</th>
                        <th colspan="2"  >Total</th>
                    </tr>
                    <tr>
                        <th  style="min-width:70px;display:<%=c8Display%>;cursor:hand;" onclick="viewDPProgress('DW_PLAN_S','<%="DW_PLAN_S".equals(sortValue)?sortType:""%>')">Plan<%="DW_PLAN_S".equals(sortValue)?sortImage:""%></th>
                        <th  style="min-width:70px;display:<%=c8Display%>;cursor:hand;" onclick="viewDPProgress('DW_ACT_S','<%="DW_ACT_S".equals(sortValue)?sortType:""%>')">Action<%="DW_ACT_S".equals(sortValue)?sortImage:""%></th>
                        <th  style="min-width:70px;display:<%=c9Display%>;cursor:hand;" onclick="viewDPProgress('DW_PLAN_F','<%="DW_PLAN_F".equals(sortValue)?sortType:""%>')">Plan<%="DW_PLAN_F".equals(sortValue)?sortImage:""%></th>
                        <th  style="min-width:70px;display:<%=c9Display%>;cursor:hand;" onclick="viewDPProgress('DW_ACT_F','<%="DW_ACT_F".equals(sortValue)?sortType:""%>')">Action<%="DW_ACT_F".equals(sortValue)?sortImage:""%></th>
                        <th  style="min-width:70px;display:<%=c10Display%>;cursor:hand;" onclick="viewDPProgress('OW_PLAN_S','<%="OW_PLAN_S".equals(sortValue)?sortType:""%>')">Plan<%="OW_PLAN_S".equals(sortValue)?sortImage:""%></th>
                        <th  style="min-width:70px;display:<%=c10Display%>;cursor:hand;" onclick="viewDPProgress('OW_ACT_S','<%="OW_ACT_S".equals(sortValue)?sortType:""%>')">Action<%="OW_ACT_S".equals(sortValue)?sortImage:""%></th>
                        <th  style="min-width:70px;display:<%=c11Display%>;cursor:hand;" onclick="viewDPProgress('OW_PLAN_F','<%="OW_PLAN_F".equals(sortValue)?sortType:""%>')">Plan<%="OW_PLAN_F".equals(sortValue)?sortImage:""%></th>
                        <th  style="min-width:70px;display:<%=c11Display%>;cursor:hand;" onclick="viewDPProgress('OW_ACT_S','<%="OW_ACT_S".equals(sortValue)?sortType:""%>')">Action<%="OW_ACT_S".equals(sortValue)?sortImage:""%></th>
                        <th  style="min-width:70px;display:<%=c12Display%>;cursor:hand;" onclick="viewDPProgress('CL_PLAN_S','<%="CL_PLAN_S".equals(sortValue)?sortType:""%>')">Plan<%="CL_PLAN_S".equals(sortValue)?sortImage:""%></th>
                        <th  style="min-width:70px;display:<%=c12Display%>;cursor:hand;" onclick="viewDPProgress('CL_ACT_S','<%="CL_ACT_S".equals(sortValue)?sortType:""%>')">Action<%="CL_ACT_S".equals(sortValue)?sortImage:""%></th>
                        <th  style="min-width:70px;display:<%=c13Display%>;cursor:hand;" onclick="viewDPProgress('CL_PLAN_F','<%="CL_PLAN_F".equals(sortValue)?sortType:""%>')">Plan<%="CL_PLAN_F".equals(sortValue)?sortImage:""%></th>
                        <th  style="min-width:70px;display:<%=c13Display%>;cursor:hand;" onclick="viewDPProgress('CL_ACT_F','<%="CL_ACT_F".equals(sortValue)?sortType:""%>')">Action<%="CL_ACT_F".equals(sortValue)?sortImage:""%></th>
                        <th  style="min-width:70px;display:<%=c14Display%>;cursor:hand;" onclick="viewDPProgress('RF_PLAN_S','<%="RF_PLAN_S".equals(sortValue)?sortType:""%>')">Plan<%="RF_PLAN_S".equals(sortValue)?sortImage:""%></th>
                        <th  style="min-width:70px;display:<%=c14Display%>;cursor:hand;" onclick="viewDPProgress('RF_ACT_S','<%="RF_ACT_S".equals(sortValue)?sortType:""%>')">Action<%="RF_ACT_S".equals(sortValue)?sortImage:""%></th>
                        <th  style="min-width:70px;display:<%=c15Display%>;cursor:hand;" onclick="viewDPProgress('WK_PLAN_S','<%="WK_PLAN_S".equals(sortValue)?sortType:""%>')">Plan<%="WK_PLAN_S".equals(sortValue)?sortImage:""%></th>
                        <th  style="min-width:70px;display:<%=c15Display%>;cursor:hand;" onclick="viewDPProgress('WK_ACT_S','<%="WK_ACT_S".equals(sortValue)?sortType:""%>')">Action<%="WK_ACT_S".equals(sortValue)?sortImage:""%></th>
						<th  style="min-width:120px;" nowrap>NEW</td>
						<th  style="min-width:120px;" nowrap>OLD</td>
						<th  style="min-width:70px;" nowrap>NEW</td>
						<th  style="min-width:70px;" nowrap>OLD</td>
						<th  style="min-width:70px;" nowrap>일정차이</td>
                        <th  style="min-width:50px;" nowrap>STD</td>
                        <th  style="min-width:55px;" nowrap>FollowUp</td>
                        <th  style="min-width:50px;" nowrap>STD</td>
                        <th  style="min-width:55px;" nowrap>FollowUp</td>
                        <th  style="min-width:50px;" nowrap>STD</td>
                        <th  style="min-width:55px;" nowrap>FollowUp</td>
...
<table id="" border="0" cellpadding="0" cellspacing="0" width="100%" align="left">
    <tr valign="top">
        <td  width="400px">
            <div id="list_left" style="width:400px; height:500px; overflow-x:scroll;overflow-y:hidden;"> 
                <table id="table_data1" class="insertArea">
                <%
                for (int i = 0; designProgressList != null && i < designProgressList.size(); i++)
                {
                    ...
                    <tr onMouseOver="trOnMouseOver('<%=dwgCode%>');" deptCodeData="<%=deptCodeData%>" dwgCode="<%=dwgCode%>">
                        <td id="td_list_no" 				 style="min-width:24px" width="24" bgcolor="#eeeeee"><%=i+1%></td>
                        <td id="td_list_project" 			 width="50" style="min-width:50px;display:<%=c1Display%>;"><%=projectNoData%></td>
                        <td id="td_list_part" 				 width="90" style="min-width:90px;display:<%=c2Display%>;">
                            <nobr id="list_part" style="display:block;width:80;overflow:hidden;text-overflow:ellipsis;"><%=deptName%></nobr>
                        </td>
                        <td id="td_list_drawingno" 			 style="min-width:70px;display:<%=c3Display%>;"><%=dwgCode%></td>
                        <td id="td_list_zone" 				 style="min-width:40px;display:<%=c4Display%>;"><%=dwgZone%></td>
                        <td id="td_list_outsourcingplan1" 	 style="min-width:27px;display:<%=c5Display%>;"><%=outsourcingYN%></td>
                        <td id="td_list_outsourcingplan2" 	 style="min-width:26px;display:<%=c5Display%>;"><%=outsourcing1%></td>
                        <td id="td_list_outsourcingplan3" 	 style="min-width:26px;display:<%=c5Display%>;"><%=outsourcing2%></td>
                        <td id="td_list_task" 				 width="<%=iTitleW%>px" style="min-width:<%=iTitleW%>px;max-width:<%=iTitleW%>px;text-align:left;display:<%=c6Display%>;word-break:break-all;" onmouseover="showhint(this, '<%=dwgTitleHint%>');">
                            <nobr id="list_task" 			style="display:block;width:<%=iTitleLetterW%>;overflow:hidden;text-overflow:ellipsis;"><%=dwgTitle%></nobr>
                        </td>
                        <% if (isEditable) { %>
                            <td id="td_list_user" class="td_smallYellowBack" width="50" onclick="selectPartPerson(this, '<%=dwgCode%>DW', '<%=empNo%>');" style="min-width:50px;display:<%=c7Display%>;"><%=empName%></td> 
                            <td id="td_list_subuser" class="td_smallYellowBack" width="50" onclick="selectPartOutsidePerson(this, '<%=dwgCode%>DW', '<%=sub_empNo%>');" style="min-width:50px;display:<%=c16Display%>;"><%=sub_empName%></td> 
                        <% } else { %>
                            <td id="td_list_user"  style="min-width:50px;display:<%=c7Display%>;"><%=empName%></td>
                            <td id="td_list_subuser"  style="min-width:50px;display:<%=c16Display%>;"><%=sub_empName%></td> 
                        <% } %>
                    </tr>
        ...
        <td id="td_list_right" align="left">
            <div id="list_right" style="margin-left:5px;width:1500px;height:500px;overflow:scroll;"> 
                ...
                for (int i = 0; designProgressList != null && i < designProgressList.size(); i++)
                {
                    ...
                    String newActivityDesc1 = (String)designProgressMap.get("NEW_ACTIVITY_DESC1");
                    String oldActivityDesc1 = (String)designProgressMap.get("OLD_ACTIVITY_DESC1");
                    String newActivityDesc2 = (String)designProgressMap.get("NEW_ACTIVITY_DESC2");
                    String oldActivityDesc2 = (String)designProgressMap.get("OLD_ACTIVITY_DESC2");
                    String diffDate = (String)designProgressMap.get("DIFF_DATE");
                    ...
                    String sumBomQty = (String)designProgressMap.get("SUM_BOM_QTY");
                    ...
                    String activityDescBGColor1 = "#ffffff"; if ( !newActivityDesc1.equals(oldActivityDesc1)) activityDescBGColor1 = "#33cc33";
                    String activityDescBGColor2 = "#ffffff"; if ( !newActivityDesc2.equals(oldActivityDesc2)) activityDescBGColor2 = "#33cc33";
                    String diffDateColor = "#ffffff"; if ( diffDate != "" ) if ( Integer.parseInt(diffDate) < 0 ) diffDateColor = "#ff0000";
                    
                    %>

                    <tr  onMouseOver="trOnMouseOver('<%=dwgCode%>');">
                        <td style="min-width:40px;cursor:hand;" onclick="showDeployRevInfo('<%=dwgCode%>');">
                            <%=deployRev%>
                        </td> 
                        <td  style="min-width:70px;cursor:hand;" onclick="showDeployRevInfo('<%=dwgCode%>');">
                            <%=deployDate%>
                        </td> 

                        <td  style="min-width:70px;display:<%=c8Display%>;"><%=dwPlanStart%></td>                        
                        <% if (isEditable && !StringUtil.isNullString(dwPlanStart)) { %>
                         <td onclick="selectActionDate(this, '<%=dwgCode%>DW', 'S', '<%=dwActionStart%>', false);"  
                             ondblclick="deleteActionDate(this, '<%=dwgCode%>DW', 'S', '<%=dwActionStart%>', false);" 
                             style="min-width:70px;background-color:<%=dwActionStartBGColor%>;display:<%=c8Display%>;<%=dwAttr4Style%>">
                             <%=dwActionStart%>
                         </td>
                        <% } else { 
                            if (dwActionStartBGColor.equals("#ffffe0")) dwActionStartBGColor = "#ffffff";
                        %>
                        <td style="min-width:70px;background-color:<%=dwActionStartBGColor%>;display:<%=c8Display%>;<%=dwAttr4Style%>">
                            <%=dwActionStart%>
                        </td>
                        <% } %>
                        
                        <td style="min-width:70px;display:<%=c9Display%>;"><%=dwPlanFinish%></td>
                        <% if (isEditable && !StringUtil.isNullString(dwPlanFinish)) { %>
                        <td  onclick="selectActionDate(this, '<%=dwgCode%>DW', 'F', '<%=dwActionFinish%>', false);" 
                            ondblclick="deleteActionDate(this, '<%=dwgCode%>DW', 'F', '<%=dwActionFinish%>', false);" 
                            style="min-width:70px;background-color:<%=dwActionFinishBGColor%>;display:<%=c9Display%>;<%=dwAttr5Style%>"><%=dwActionFinish%></td>
                        <% } else { 
                            if (dwActionFinishBGColor.equals("#ffffe0")) dwActionFinishBGColor = "#ffffff";
                        %>
                        <td style="min-width:70px;background-color:<%=dwActionFinishBGColor%>;display:<%=c9Display%>;<%=dwAttr5Style%>">
                            <%=dwActionFinish%>
                        </td>
                        <% } %>

                        <td style="min-width:70px;display:<%=c10Display%>;"><%=owPlanStart%></td>
                        <% if (isEditable && !StringUtil.isNullString(owPlanStart)) { %>
                        <td onclick="selectActionDate(this, '<%=dwgCode%>OW', 'S', '<%=owActionStart%>', <%=owStartFinishEqual%>);" 
                            ondblclick="deleteActionDate(this, '<%=dwgCode%>OW', 'S', '<%=owActionStart%>', <%=owStartFinishEqual%>);" 
                            style="min-width:70px;background-color:<%=owActionStartBGColor%>;display:<%=c10Display%>;<%=owAttr4Style%>"><%=owActionStart%></td>
                        <% } else { 
                            if (owActionStartBGColor.equals("#ffffe0")) owActionStartBGColor = "#ffffff";
                        %>
                        <td style="min-width:70px;background-color:<%=owActionStartBGColor%>;display:<%=c10Display%>;<%=owAttr4Style%>">
                            <%=owActionStart%>
                        </td>
                        <% } %>
                        
                        <% if (!owStartFinishEqual) { %>
                        <td  style="min-width:70px;display:<%=c11Display%>;"><%=owPlanFinish%></td>
	                       <% if (isEditable && !StringUtil.isNullString(owPlanFinish)) { %>
	                           <td onclick="selectActionDate(this, '<%=dwgCode%>OW', 'F', '<%=owActionFinish%>', <%=owStartFinishEqual%>);" 
	                               ondblclick="deleteActionDate(this, '<%=dwgCode%>OW', 'F', '<%=owActionFinish%>', <%=owStartFinishEqual%>);" 
	                               style="min-width:70px;background-color:<%=owActionFinishBGColor%>;display:<%=c11Display%>;<%=owAttr5Style%>"><%=owActionFinish%></td>
                            <% } else { 
                                if (owActionFinishBGColor.equals("#ffffe0")) owActionFinishBGColor = "#ffffff";
                            %>
                                <td style="min-width:70px;background-color:<%=owActionFinishBGColor%>;display:<%=c11Display%>;<%=owAttr5Style%>">
                                    <%=owActionFinish%>
                                </td>
                            <% } %>

                        <% } else { %>
                            <td  style="min-width:70px;background-color:#dddddd;display:<%=c11Display%>;<%=owAttr5Style%>">&nbsp;</td>
                            <td  style="min-width:70px;background-color:#dddddd;display:<%=c11Display%>;<%=owAttr5Style%>">&nbsp;</td>
                        <% } %>
                        
                        <td  style="min-width:70px;display:<%=c12Display%>;"><%=clPlanStart%></td>
                        <% if ((isEditable || isEditable2) && !StringUtil.isNullString(clPlanStart)) { %>
                            <td  
                                ...
                                style="min-width:70px;background-color:<%=clActionStartBGColor%>;display:<%=c12Display%>;<%=clAttr4Style%>"><%=clActionStart%></td>
                        <% } else { 
                            if (clActionStartBGColor.equals("#ffffe0")) clActionStartBGColor = "#ffffff";
                        %>
                            <td  
                                style="min-width:70px;background-color:<%=clActionStartBGColor%>;display:<%=c12Display%>;<%=clAttr4Style%>">
                                <%=clActionStart%>
                            </td>
                        <% } %>
    
                        <% if (!clStartFinishEqual) { %>
                            <td  style="min-width:70px;display:<%=c13Display%>;"><%=clPlanFinish%></td>
                            <% if ((isEditable || isEditable2) && !StringUtil.isNullString(clPlanFinish)) { %>
                                <td  
                                    ...
                                    style="min-width:70px;background-color:<%=clActionFinishBGColor%>;display:<%=c13Display%>;<%=clAttr5Style%>"><%=clActionFinish%></td>
                            <% } else { 
                                if (clActionFinishBGColor.equals("#ffffe0")) clActionFinishBGColor = "#ffffff";
                            %>
                                <td  
                                    style="min-width:70px;background-color:<%=clActionFinishBGColor%>;display:<%=c13Display%>;<%=clAttr5Style%>">
                                    <%=clActionFinish%>
                                </td>
                            <% } %>

                        <% } else { %>
                            <td  style="min-width:70px;background-color:#dddddd;display:<%=c13Display%>;<%=clAttr5Style%>">&nbsp;</td>
                            <td  style="min-width:70px;background-color:#dddddd;display:<%=c13Display%>;<%=clAttr5Style%>">&nbsp;</td>
                        <% } %>
                        
                        <td  style="min-width:70px;display:<%=c14Display%>;"><%=rfPlanStart%></td>
                        <% if (isEditable && !StringUtil.isNullString(rfPlanStart)) { %>
                            <td  
                                ...
                                style="min-width:70px;background-color:<%=rfActionStartBGColor%>;display:<%=c14Display%>;<%=rfAttr4Style%>"><%=rfActionStart%></td>
                        <% } else { 
                            if (rfActionStartBGColor.equals("#ffffe0")) rfActionStartBGColor = "#ffffff";
                        %>
                            <td  
                                style="min-width:70px;background-color:<%=rfActionStartBGColor%>;display:<%=c14Display%>;<%=rfAttr4Style%>">
                                <%=rfActionStart%>
                            </td>
                        <% } %>

                        <td  style="min-width:70px;display:<%=c15Display%>;"><%=wkPlanStart%></td>
                        <% if (isEditable && !StringUtil.isNullString(wkPlanStart)) { %>
                            <td  
                                ...
                                style="min-width:70px;background-color:<%=wkActionStartBGColor%>;display:<%=c15Display%>;<%=wkAttr4Style%>"><%=wkActionStart%></td>
                        <% } else { 
                            if (wkActionStartBGColor.equals("#ffffe0")) wkActionStartBGColor = "#ffffff";
                        %>
                            <td  
                                style="min-width:70px;background-color:<%=wkActionStartBGColor%>;display:<%=c15Display%>;<%=wkAttr4Style%>">
                                <%=wkActionStart%>
                            </td>
                        <% } %>
                        <!-- 
                        <td style="min-width:70px"  onmouseover="showhint(this, '<%=activityDesc1%>');">
                            <nobr style="min-width:100px;display:block;width:94;overflow:hidden;text-overflow:ellipsis;"><%=activityDesc1%></nobr>
                        </td> 
                        <td  width="70" style="min-width:70px" ><%=activityDesc2%></td> 
						-->
						<td  width="120" style="min-width:120px; background-color:<%=activityDescBGColor1%>;" nowrap><%=newActivityDesc1%></td> 
						<td  width="120" style="min-width:120px; background-color:<%=activityDescBGColor1%>;" nowrap><%=oldActivityDesc1%></td>
						 
						<td  width="70" style="min-width:70px; background-color:<%=activityDescBGColor2%>;" nowrap><%=newActivityDesc2%></td> 
						<td  width="70" style="min-width:70px; background-color:<%=activityDescBGColor2%>;" nowrap><%=oldActivityDesc2%></td> 
						<td  width="70" style="min-width:70px; color:<%=diffDateColor%>;" nowrap><%=diffDate%></td> 
						
                        <td  width="50" style="min-width:50px" ><%=planSTD%></td> 
                        <td  width="55" style="min-width:55px" ><%=planFollowup%></td> 
                        <td  width="50" style="min-width:50px" ><%=internalSTD%></td>
                        <td  width="55" style="min-width:55px" ><%=internalFollowup%></td> 
                        <td  width="50" style="min-width:50px" ><%=outSTD%></td> 
                        <td  width="55" style="min-width:55px" ><%=outFollowup%></td> 
                        <td  width="50" style="min-width:50px" ><%=stdTotal%></td>
                        <td  width="55" style="min-width:55px" ><%=followupTotal%></td>
                        
                        <td  width="70" style="min-width:70px" ><%=sumBomQty%></td>
                    </tr>
...
<div id="dummyDiv" style="width=0px;border:0;height:0px;">
    <input type="text" name="dummyText" id="dummyText" onchange="dateChanged();" style="border:0;width=0px;height:0px;" />
</div>
</form>
...
<script language="javascript">
	...
	document.onkeydown = keydownHandler;
	 ...
	 $(window).bind('resize', function() {
		 	$("#header_right").css({'width': $(window).width() - 410});
			$("#list_right").css({'width': $(window).width() -410});
			
			$("#list_left").css({'height': $(window).height() -90});
			$("#list_right").css({'height': $(window).height() -90});
		}).trigger('resize');
    <% if (designProgressList == null) { %>
        parent.DPProgressViewHeader.projectTotal.value = "";
    <% } else { %>
        parent.DPProgressViewHeader.projectTotal.value = <%= designProgressList.size() %>;
    <% } %>
    ...
    function fnGetChangableDateProjectDP(PROJECTNO,ACTIVITYCODE,startFinishCode)
    {
		...
		xmlHttp.open("GET", "stxPECDP_GeneralAjaxProcess.do?requestProc=getAbleChangeDPDate&PROJECTNO=" + PROJECTNO + "&ACTIVITYCODE=" + ACTIVITYCODE+ "&startFinishCode=" + startFinishCode, false);
		xmlHttp.send(null);
    ...
    {
    	if(event.ctrlKey) { 
    		 deleteActionDate(tdObject, activityCode, startFinishCode, currentData, isStartEndEqual);
    		 return;
    	}
        ...
        $("#dummyDiv").css({
       	   "position" : "absolute",
       	   "top" : objPosition.y-$("#list_right").scrollTop(),
       	   "left" : objPosition.x-$("#list_right").scrollLeft()
       	});

        $('#dummyText').datepicker('show');
    ...
    function saveDPProgress()
    {
        ...
        params += "&loginID=" + parent.DPProgressViewHeader.loginID.value;

        var resultMsg = callDPCommonAjaxPostProc("SaveDPProgress", params);
        if (resultMsg == "Y") {
            alert("저장 완료");

            var urlStr = "stxPECDPProgressViewMain.do?projectNo=" + DPProgressViewMain.projectNo.value;
            ...
            urlStr += "&titleSize=" + parent.DPProgressViewHeader.titleSize.value;
            
            
	        urlStr += "&c1=" + parent.DPProgressViewHeader.colShowCheck1.checked;
	        urlStr += "&c2=" + parent.DPProgressViewHeader.colShowCheck2.checked;
	        urlStr += "&c3=" + parent.DPProgressViewHeader.colShowCheck3.checked;
	        urlStr += "&c4=" + parent.DPProgressViewHeader.colShowCheck4.checked;
	        urlStr += "&c5=" + parent.DPProgressViewHeader.colShowCheck5.checked;
	        urlStr += "&c6=" + parent.DPProgressViewHeader.colShowCheck6.checked;
	        urlStr += "&c7=" + parent.DPProgressViewHeader.colShowCheck7.checked;
	        urlStr += "&c8=" + parent.DPProgressViewHeader.colShowCheck8.checked;
	        urlStr += "&c9=" + parent.DPProgressViewHeader.colShowCheck9.checked;
	        urlStr += "&c10=" + parent.DPProgressViewHeader.colShowCheck10.checked;
	        urlStr += "&c11=" + parent.DPProgressViewHeader.colShowCheck11.checked;
	        urlStr += "&c12=" + parent.DPProgressViewHeader.colShowCheck12.checked;
	        urlStr += "&c13=" + parent.DPProgressViewHeader.colShowCheck13.checked;
	        urlStr += "&c14=" + parent.DPProgressViewHeader.colShowCheck14.checked;
	        urlStr += "&c15=" + parent.DPProgressViewHeader.colShowCheck15.checked;

                    
            /* parent.PROGRESS_VIEW_MAIN.location = urlStr; */
	        parent.$("#PROGRESS_VIEW_MAIN").attr("src", urlStr);
        }
        else alert("에러 발생");
    }
    ...
    function showDeployRevInfo(dwgCode)
    {
        ...
        var url = "stxPECDPDwgRevisionHistoryView.do?projectNo=" + DPProgressViewMain.projectNo.value;
        url += "&dwgNo=" + dwgCode;
    ...
    */
    ...
    {
        var urlStr = "stxPECDPProgressViewMain.do?projectNo=" + parent.DPProgressViewHeader.projectList.value;
        urlStr += "&deptCode=" + parent.DPProgressViewHeader.departmentList.value;
        urlStr += "&designerID=" + parent.DPProgressViewHeader.designerList.value;
        urlStr += "&dateFrom=" + parent.DPProgressViewHeader.dateSelectedFrom.value;
        urlStr += "&dateTo=" + parent.DPProgressViewHeader.dateSelectedTo.value;
        urlStr += "&dateCondition=" + parent.DPProgressViewHeader.dateCondition.value;
        urlStr += "&drawingNo1=" + parent.DPProgressViewHeader.drawingNo1.value;
        urlStr += "&drawingNo2=" + parent.DPProgressViewHeader.drawingNo2.value;
        urlStr += "&drawingNo3=" + parent.DPProgressViewHeader.drawingNo3.value;
        urlStr += "&drawingNo4=" + parent.DPProgressViewHeader.drawingNo4.value;
        urlStr += "&drawingNo5=" + parent.DPProgressViewHeader.drawingNo5.value;
        urlStr += "&drawingNo6=" + parent.DPProgressViewHeader.drawingNo6.value;
        urlStr += "&drawingNo7=" + parent.DPProgressViewHeader.drawingNo7.value;
        urlStr += "&drawingNo8=" + parent.DPProgressViewHeader.drawingNo8.value;
        urlStr += "&drawingTitle=" + parent.DPProgressViewHeader.drawingTitle.value;
        urlStr += "&isManager=" + parent.DPProgressViewHeader.isManager.value;
        urlStr += "&isAdmin=" + parent.DPProgressViewHeader.isAdmin.value;
        urlStr += "&userDept=" + parent.DPProgressViewHeader.dwgDepartmentCode.value;

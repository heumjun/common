...
<div id="lockListDiv" STYLE="height:300px; width:390px; overflow:auto;">
...
<div id="lockListDiv" STYLE="overflow:auto;">
    <table width="100%">
        <tr height="50">
            <td style="text-align:right;">
                <input type="button" value="저 장" class="btn_blue" onclick="updateDPProgressLockList();">&nbsp;&nbsp;

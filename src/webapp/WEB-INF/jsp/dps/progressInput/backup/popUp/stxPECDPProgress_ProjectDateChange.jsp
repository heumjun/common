...
<script language="javascript">
    ...
    function updateSearchableProjectList()
    {
		...
		xmlHttp.open("POST", "stxPECDP_GeneralAjaxProcess.do?requestProc=setChangableDPDate&params=" + params,false);
		xmlHttp.send(null);
...
<table width="100%" height="550px" cellSpacing="0" cellpadding="6" border="0">
	<tr>
    ...
    <td style="vertical-align:top;" colspan="6">
        <div STYLE="height:360px; overflow:auto; position:relative;">
    ...
    <tr height="45">
        <td style="vertical-align:middle;text-align:right;" colspan="6">
            <input type="button" value="확 인" class="btn_blue" onclick="updateSearchableProjectList();">&nbsp;&nbsp;
            <input type="button" value="취 소" class="btn_blue" onclick="javascript:window.close();">&nbsp;&nbsp;&nbsp;
        </td>
    </tr>

...
<table width="100%" cellSpacing="0" cellpadding="6" border="0" align="center">
        ...
        <table width="100%" cellSpacing="0" cellpadding="0" border="1" align="center">
            ...
            for (int i = 0; allProjectList != null && i < allProjectList.size(); i++) 
            {
                ...
                <tr height="20" style="background-color:#ffffe0">
                    <td width="140" class="td_standard"><%=projectNo%>  <%=state %>1111</td>
    ...
    <tr height="45">
        <td style="vertical-align:middle;text-align:right;">
            <input type="button" value="확인" class="btn_blue" onclick="updateSearchableProjectList();">&nbsp;&nbsp;
            <input type="button" value="취소" class="btn_blue" onclick="javascript:window.close();">&nbsp;&nbsp;&nbsp;
        </td>
    </tr>
...
<script language="javascript">
    ...
    function updateSearchableProjectList()
    {
		...
		xmlHttp.open("GET", "stxPECDP_GeneralAjaxProcess.do?requestProc=UpdateSearchableProjectList&params=" + params + 

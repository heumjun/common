...
<%	
	...
	System.out.println(ACTIVITY);
	ArrayList mlList = SQLSourceUtil.executeSelect("PLM","PIPINGIO.selectSTX_PIPING_IO_ACT_DB_APP",preSQL(mapParam));
%>
					...
					<div id="listDiv" STYLE="width:100%; height:500; overflow-x:scroll;overflow-y:scroll;  left:1; top:20;"> 
	         				<table id="dataTable" width="1200" cellSpacing="1" cellpadding="0" border="0" align="left" style="table-layout:fiexed;">
		              			<tr>
	         						...
	         						<td class="td_header" colspan="5">DESIGN SUBJECT</td>
									<td class="td_header" colspan="2">INPUT DATA</td>
									<td class="td_header" rowspan="2" width="5%">OUTPUT DATA</td>
									<td class="td_header" colspan="3">PROCESSING</td>
									<td class="td_header" rowspan="2" width="5%">EVENT</td>
									<td class="td_header" rowspan="2" width="5%">FACTOR</td>
	         					</tr>
	         					<tr>
									<td class="td_header" width="3%" >승인요청자</td>
									<td class="td_header" width="3%" >선종</td>
						...
						%>
							<tr edit="false" class="<%=sTRClass%>" PIPING_IO_ID="<%=mapResult.get("PIPING_IO_ID")%>" PROJECT="<%=mapResult.get("PROJECT")%>" >
								...
								<td class="data" align="center" alias="APP_MSG" >
									<%=mapResult.get("REQUESTER_NM")%>
								</td>
								<td class="data" align="center" alias="SHIPTYPE" >
									<%=mapResult.get("SHIPTYPE")%>
								</td>
								<td class="data" align="center" alias="AREA" >
									<%=mapResult.get("AREA")%>
								</td>
								<td class="data" align="center" alias="SYSTEM" >
									<%=mapResult.get("SYSTEM")%>
								</td>
								<td class="data" align="center" alias="ITEM" >
									<%=mapResult.get("ITEM")%>
								</td>
								<td class="data" align="center" alias="DETAILS" >
									<%=mapResult.get("DETAILS")%>
								</td>
								<td class="data" align="center" alias="CONDERATIONS" >
									<%=mapResult.get("CONDERATIONS")%>
								</td>
								<td class="data" align="center" alias="OUTPUT" >
								...
								<td class="data" align="left" alias="EVENT" >
									<%=mapResult.get("EVENT")%>
								</td>
								<td class="data" align="left" alias="FACTOR" >
									<%=mapResult.get("FACTOR")%>
								</td>
							</tr>
						<%
						}

...
§FILENAME: stxEPDocumentViewFrame.jsp
--%>
...
<%  // 품목 부품표준서 view Frame 
	...
	String frameMain  	= "stxEPInfoDocuments.jsp?loginID="+loginID;
    ...
    <tr>
        <td>
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td>
                        <iframe name="DOCUMENT_FRAME_MAIN" src="<%=frameMain%>" width="100%" height="490" frameborder="0" scrolling=no></iframe> 
                    </td>
                </tr>
            </table>
        </td>

...
§FILENAME: stxPECEquipItemPurchasingScheduleManagementRegisterApprovePR.jsp
§CHANGING HISTORY: 
...
<script language="javascript">
    ...
    var urlStr = "stxPECEquipItemPurchasingScheduleManagementRegisterSearchPrPoInfo.jsp?projectNo=<%=projectNo%>";
    urlStr += "&prNo=<%=prNo%>";

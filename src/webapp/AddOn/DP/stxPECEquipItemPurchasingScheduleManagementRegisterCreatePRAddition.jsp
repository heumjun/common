...
§FILENAME: stxPECEquipItemPurchasingScheduleManagementRegisterCreatePRAddition.jsp
--%>
...
<%
	...
	System.out.println( "~~ CreatePR start :: stxPECEquipItemPurchasingScheduleManagementRegisterCreatePRAddition" );
    // 파일 업로드 디렉토리 설정
	...
	*****/
	...
	tempMap.put("addComment", multi.getParameter("addComment"+checkboxValue) == null ? "" : multi.getParameter("addComment"+checkboxValue));

	tempMap.put("addCharge", multi.getParameter("addCharge"+checkboxValue) == null ? "" : multi.getParameter("addCharge"+checkboxValue));
	tempMap.put("addChargeReceiver", multi.getParameter("addChargeReceiver") == null ? "" : multi.getParameter("addChargeReceiver"));
	tempMap.put("addChargeReason", multi.getParameter("addChargeReason") == null ? "" : multi.getParameter("addChargeReason"));
	tempMap.put("addChargeContents", multi.getParameter("addChargeContents") == null ? "" : multi.getParameter("addChargeContents"));
	tempMap.put("addChargeAction", multi.getParameter("addChargeAction") == null ? "" : multi.getParameter("addChargeAction"));
    ...
    if(resultList.size() > 0)
    {
        ...
        try
        {
            ...
            for(int j=0; j < resultList.size(); j++)
            {
				...
				String addComment =  (String) resultMap.get("addComment");
				String addCharge =  (String) resultMap.get("addCharge");
				String addChargeReceiver =  (String) resultMap.get("addChargeReceiver");
				String addChargeReason =  (String) resultMap.get("addChargeReason");
				String addChargeContents =  (String) resultMap.get("addChargeContents");
				String addChargeAction =  (String) resultMap.get("addChargeAction");

				String mailDescription = "";

				// 추가예산신청 대상은 PR Descripion에 표기
				if("TRUE".equals(addCharge))
				{
					mailDescription = "[추가예산신청] "+projectNo + "  ( "+drawingTitle+" ) : "+addComment;
				} else {
					mailDescription = projectNo + "  ( "+drawingTitle+" ) : "+addComment;
				}
               ...
               //  cs1.execute();
				...
				// 2013-11-28 Kang seonjung : 추가예산 신청 대상일 경우 관련정보 저장
				if("TRUE".equals(addCharge))
				{
					StringBuffer addChargeInsertSQL = new StringBuffer();
					addChargeInsertSQL.append("INSERT INTO STX_PO_EQUIPMENT_DP_CHARGE(	PROJECT_NUMBER,               \n");
					addChargeInsertSQL.append(" 									DRAWING_NO,                      \n");
					addChargeInsertSQL.append(" 									PR_NO,                        \n");
					addChargeInsertSQL.append(" 									RECEIVER,                      \n");
					addChargeInsertSQL.append(" 									REASON,                          \n");
					addChargeInsertSQL.append(" 									CONTENT,                        \n");
					addChargeInsertSQL.append(" 									ACTION,                               \n");
					addChargeInsertSQL.append(" 									UPDATE_DATE,                   \n");
					addChargeInsertSQL.append(" 									UPDATE_BY,                     \n");
					addChargeInsertSQL.append(" 									CREATE_DATE,                       \n");
					addChargeInsertSQL.append(" 									CREATE_BY)                    \n");
					addChargeInsertSQL.append("                     VALUES (       ?                                    \n");
					addChargeInsertSQL.append("                                   ,?                                    \n");                             
					addChargeInsertSQL.append("                                   ,?                                    \n");
					addChargeInsertSQL.append("                                   ,?                                    \n");
					addChargeInsertSQL.append("                                   ,?                                    \n");
					addChargeInsertSQL.append("                                   ,?                                    \n");
					addChargeInsertSQL.append("                                   ,?                                    \n");
					addChargeInsertSQL.append("                                   ,sysdate                              \n");
					addChargeInsertSQL.append("                                   ,?                                    \n");
					addChargeInsertSQL.append("                                   ,sysdate                              \n");
					addChargeInsertSQL.append("                                   ,?  )                                  \n");

					pstmt8 = conn.prepareStatement(addChargeInsertSQL.toString());

					StringTokenizer addChargeReceiverToken = new StringTokenizer(addChargeReceiver, ",");
					while (addChargeReceiverToken.hasMoreTokens())
					{
						String temp_addChargeReceiver = addChargeReceiverToken.nextToken();	

						pstmt8.setString(1, projectNo);
						pstmt8.setString(2, drawingNo);
						pstmt8.setString(3, retPrNo);
						pstmt8.setString(4, temp_addChargeReceiver);
						pstmt8.setString(5, addChargeReason);
						pstmt8.setString(6, addChargeContents);
						pstmt8.setString(7, addChargeAction);
						pstmt8.setString(8, prCreator);
						pstmt8.setString(9, prCreator);
    ...
    System.out.println( "~~ CreatePR end :: stxPECEquipItemPurchasingScheduleManagementRegisterCreatePRAddition" );

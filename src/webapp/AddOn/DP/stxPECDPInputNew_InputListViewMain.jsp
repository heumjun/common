...
§FILENAME: stxPECDPInputNew_InputListViewMain.jsp
§CHANGING HISTORY: 
...
<%!
	        ...
	        String causeDeptCode, String[] drawingNoArray, String opCode, String e1, String e2, String e3) throws Exception
	{
		...
		try {
			...
			queryStr.append("       (SELECT B.SUB_DESC FROM PLM_DESIGN_MH_OP_SUB B WHERE B.GRT_CODE||B.MID_CODE||B.SUB_CODE=A.OP_CODE) AS OP_STR,            "); // PLM_CODE_TBL에서 가져오던것을 OP TABLE에서 가져오도록 변경

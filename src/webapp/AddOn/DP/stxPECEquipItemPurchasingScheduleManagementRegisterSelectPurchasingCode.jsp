...
§FILENAME: stxPECEquipItemPurchasingScheduleManagementRegisterSelectPurchasingCode.jsp
§CHANGING HISTORY: 
		...
		try {
            ...
            for(int i=0; i<catalogList.size(); i++)
            {
                ...
                if( sCatalog.startsWith("Z") || sCatalog.startsWith("3BF") || sCatalog.startsWith("3BG") || sCatalog.startsWith("1AC") || sCatalog.startsWith("1B1") || sCatalog.startsWith("3AB") )
                {
                    ...
                    queryStr.append("   and (msi.segment1 = '"+sCatalog+"-00000"+"' or msi.segment1 = '"+sCatalog+"' or msi.segment1 = '"+sCatalog+"-R"+"' )    \n");    //2015-02-11 Kang seonjung : 비표준품인데 실코드 PR을 위해 대표코드 이외의 정의된 실품목을 가져올 수 있도록 수정, 비용성코드(-R) 가져오도록 수정
                } else {

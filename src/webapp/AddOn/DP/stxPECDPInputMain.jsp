...
<%
    ...
    String deptName = emxGetParameter(request, "deptName");
    String designerID = emxGetParameter(request, "designerID");
    String designerName = emxGetParameter(request, "designerName");
    String dateSelected = emxGetParameter(request, "dateSelected");
    String workingDayYN = emxGetParameter(request, "workingDayYN");
...
<script language="javascript">
    ...
    function showOpSelectWin(timeKey) 
    {
        ...
        var opCode = window.showModalDialog("stxPECDPInput_OpSelect.jsp?projectNo=" + projectNo, "", sProperties);
    ...
    function saveAsVacationProc(opCode)
    {
        ...
        var periodStr = window.showModalDialog("stxPECDPInput_VacationPeriodSelect.jsp?opCode=" + opCode, "", sProperties);
    ...
    function saveAsOneDayOverJob(opCode)
    {
        ...
        var returnVal = window.showModalDialog("stxPECDPInput_OneDayOverJobPeriodSelect.jsp?opCode=" + opCode, "", sProperties);
    ...
    function saveAsOneDayOverJobWithProject(opCode)
    {
        ...
        var returnVal = window.showModalDialog("stxPECDPInput_OneDayOverJobPeriodSelectPjt.jsp?" + paramStr, "", sProperties);

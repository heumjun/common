...
<%
	...
	buyerClassLetterFaxInputHead = "stxPECBuyerClassLetterFaxInputHead.jsp";
	buyerClassLetterFaxInputBody = "stxPECBuyerClassLetterFaxInputBody.jsp";
	...
	<frameset rows="<%=framesetRows%>" framespacing="0" frameborder="no" border="0">
		...
		<frame name="listBody" src="<%=buyerClassLetterFaxInputBody%>" marginheight="10" marginwidth="10" />

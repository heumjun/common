...
<%
   ...
   // String loginID = SessionUtils.getUserId();
    ...
    System.out.println("~~~ loginID(stxPECDPInputNewHeader) = "+loginID);       
...
<script language="javascript">
    ...
    function showApprovalsViewWin() 
    {
        ...
        var dhApprCheckResult = window.showModalDialog("stxPECDPApproval_ApprovalListViewFS.jsp", paramObj, sProperties);
    }
    ...
    function showInputRateViewWin() 
    {
        ...
        var dhApprCheckResult = window.showModalDialog("stxPECDPApproval_InputRateViewFS.jsp", paramObj, sProperties);
    }
    ...
    function showHolidayCheckWin() 
    {
        ...
        var dhHolidayCheckResult = window.showModalDialog("stxPECDPApproval_HolidayCheckFS.jsp", paramObj, sProperties);
    }
    ...
    function viewPartPersons()
    {
        ...
        // 파트 구성원 목록을 쿼리
        var urlStr = "stxPECDPApprovalPersonSelect.jsp?deptCode=" + DPApprovalHeader.departmentSel.value;

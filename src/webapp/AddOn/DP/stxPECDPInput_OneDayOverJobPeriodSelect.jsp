...
§FILENAME: stxPECDPInput_OneDayOverJobPeriodSelect.jsp
§CHANGING HISTORY: 
§    2009-07-16: Initiative
--%>
...
<%
    ...
    String jobDescStr = "?????";
    if (opCode.equals("36")) jobDescStr = "사외 협의 검토(공사관련 출장)";
    else if (opCode.equals("72")) jobDescStr = "기술회의 및 교육(사내외)";
    else if (opCode.equals("81")) jobDescStr = "일반출장(기술소위원회, 세미나)";
%>

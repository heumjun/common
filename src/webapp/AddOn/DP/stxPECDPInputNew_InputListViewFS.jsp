...
§FILENAME: stxPECDPInputNew_InputListViewFS.jsp
§CHANGING HISTORY: 
...
<FRAMESET rows="60, *, 60" frameborder="0" framespacing="0">
    <FRAME src="stxPECDPInputNew_InputListViewHeader.jsp?loginID=<%=loginID%>" name="DP_VIEW_HEADER" noresize scrolling="no" marginwidth="1" marginheight="1">

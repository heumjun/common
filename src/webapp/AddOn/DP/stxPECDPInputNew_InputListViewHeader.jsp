...
§FILENAME: stxPECDPInputNew_InputListViewHeader.jsp
§CHANGING HISTORY: 
§    2014-12-15: Initiative
--%>
...
<script language="javascript">    
    ...
    function viewInputList() 
    {
        ...
        */
        ...
        var urlStr = "stxPECDPInputNew_InputListViewMain.jsp?";
    ...
    function printPage()
    {
        ...
        */
        ...
        var urlStr = "http://172.16.2.13:7777/j2ee/STXDP/WebReport.jsp?src=<%=reportFileUrl%>stxPECDPInputNew_InputListView.mrd&param=" + paramStr; //LIVE               

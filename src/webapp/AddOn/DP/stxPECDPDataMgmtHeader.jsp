...
<script language="javascript">
    ...
    function departmentSelChanged() 
    {
		...
		xmlHttp.open("GET", 
            "stxPECDP_GeneralAjaxProcess.jsp?requestProc=GetPartPersons2&departCodes=" + DPDataMgmtHeader.departmentList.value, false);
		xmlHttp.send(null);
    ...
    parent.DP_DATAMGMT_MAIN.location = "stxPECDPDataMgmtMain.jsp?firstCall=Y"; 

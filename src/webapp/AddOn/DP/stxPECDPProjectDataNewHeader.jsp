<%--  
§TITLE: 호선 별 시수조회 화면 Header 부분 (New)
§AUTHOR (MODIFIER): Kang seonjung
§FILENAME: stxPECDPProjectDataNewHeader.jsp
§CHANGING HISTORY: 
...
<%--========================== HTML HEAD ===================================--%>
<html>
<head><title>호선 별 설계시수 조회</title></head>
    ...
    <table width="100%" cellSpacing="0" border="1" align="left">
        ...
        <tr height="30">
            ...
            <td width="400">일자
                ...
                <a href="javascript:showCalendar('DPProjectDataHeader', 'dateSelectedFrom', '', false, dateChangedFrom);">
                ...
                <a href="javascript:showCalendar('DPProjectDataHeader', 'dateSelectedTo', '', false, dateChanged);">
                    <img src="../common/images/iconSmallCalendar.gif" border="0" valign="absmiddle"></a>
            </td>
            <td width="320">호선
                <input type="text" name="projectList" value="" style="width:200px;" />
...
<script language="javascript">
    ...
    function showDepartmentSelectWin()
    {
        ...
        var paramStr = "selectedDepartments=" + DPProjectDataHeader.departmentList.value;
        ...
        if (selectedDepartmentsStr != null && selectedDepartmentsStr != 'undefined') 
        {
            ...
            DPProjectDataHeader.departmentList.value = strs[0];
            deptCodeHintStr = "";
            if (strs[1] != "") {
    ...
    {
        DPProjectDataHeader.departmentList.value = "";
        deptCodeHintStr = "";
        departmentSelChanged();
    }
    ...
    {
        for (var i = DPProjectDataHeader.designerList.options.length - 1; i > 0; i--) {
            DPProjectDataHeader.designerList.options[i] = null;
        }
        if (DPProjectDataHeader.departmentList.value == "") return;
		...
		xmlHttp.open("GET", 
            "stxPECDP_GeneralAjaxProcess.jsp?requestProc=GetPartPersons2&departCodes=" + DPProjectDataHeader.departmentList.value, false);
		xmlHttp.send(null);
            ...
            if (xmlHttp.statusText == "OK") {
                ...
                if (resultMsg != null) 
                {
                    ...
                    for (var i = 0; i < strs.length; i++) {
                        ...
                        DPProjectDataHeader.designerList.options[i + 1] = newOption;
                    }
    ...
    {
        var tmpStr = DPProjectDataHeader.dateSelectedFrom.value;
        if (tmpStr != null || tmpStr.trim() != "") {
            var dateStr = formatDateStr(tmpStr);
            DPProjectDataHeader.dateSelectedFrom.value = dateStr;
        }
        tmpStr = DPProjectDataHeader.dateSelectedTo.value;
        if (tmpStr != null || tmpStr.trim() != "") {
            var dateStr = formatDateStr(tmpStr);
            DPProjectDataHeader.dateSelectedTo.value = dateStr;
        }
    }
    ...
    function dateChangedFrom()
    {
        ...
        DPProjectDataHeader.dateSelectedTo.value = tmpStrs[0] + "-" + tmpStrs[1] + "-" + maxDay;
    ...
    function showProjectSelectWin() 
    {
        ...
        var paramStr = "selectedProjects=" + DPProjectDataHeader.projectList.value;
        ...
        DPProjectDataHeader.projectList.value = selectedProjects;
    }    

    // 조회 실행
    function viewDPInputsList()
    {    
        var projectStr = DPProjectDataHeader.projectList.value.trim();
        /*
        if (projectStr != "") {
        ...
        var urlStr = "stxPECDPProjectDataNewMain.jsp?";
        urlStr += "&dateFrom=" + DPProjectDataHeader.dateSelectedFrom.value;
        urlStr += "&dateTo=" + DPProjectDataHeader.dateSelectedTo.value;
        urlStr += "&factorCase=" + DPProjectDataHeader.factorCaseList.value;
        urlStr += "&projectNO=" + projectStr;
        urlStr += "&firstCall=N";
        parent.DP_PROJECTDATA_MAIN.location = urlStr;
    }
    ...
    {
    	 /********
        var departmentStr = DPProjectDataHeader.departmentList.value.trim();
        if (departmentStr != "") {
        ...
        var yearMonthStr = DPProjectDataHeader.dateSelectedFrom.value;
        ...
        urlStr += "stxPECDPProjectDataView.mrd&param=";
        urlStr += DPProjectDataHeader.dateSelectedFrom.value + ":::";
        urlStr += DPProjectDataHeader.dateSelectedTo.value + ":::";
        urlStr += departmentStr + ":::";
        urlStr += DPProjectDataHeader.factorCaseList.value + ":::";
        urlStr += yearMonthStr + ":::";
        urlStr += DPProjectDataHeader.designerList.value + ":::";
        ...
        **********/
        ...
        urlStr += DPProjectDataHeader.dateSelectedFrom.value + ":::";
        urlStr += DPProjectDataHeader.dateSelectedTo.value + ":::";
        urlStr += DPProjectDataHeader.projectList.value + ":::";
        urlStr += DPProjectDataHeader.factorCaseList.value + ":::";
        window.open(urlStr, "", "");
    }

    // ERP I/F 화면 Show
    function showERPIFWin()
    {
        var sProperties = 'dialogHeight:640px;dialogWidth:900px;center:yes;';
        window.showModalDialog("stxPECDPProjectDataERPIFFS.jsp?loginID=" + DPProjectDataHeader.loginID.value, null, sProperties);
    }
    ...
    DPProjectDataHeader.dateSelectedFrom.value = fromYMD;
    DPProjectDataHeader.dateSelectedTo.value = toYMD;
    
    // Header 페이지가 먼저 로드된 후 Main 페이지가 로드되도록
    parent.DP_PROJECTDATA_MAIN.location = "stxPECDPProjectDataNewMain.jsp?firstCall=Y"; 
...
/*
    ...
    function reportButton()
    {
        ...
        var paramStr = DPProjectDataHeader.projectList.value + ":::" + 
                       DPProjectDataHeader.departmentList.value + ":::" + 
                       DPProjectDataHeader.designerList.value + ":::";

       var fromDate = DPProjectDataHeader.dateSelectedFrom.value;
       var toDate = DPProjectDataHeader.dateSelectedTo.value;
        ...
        if ((fromDate != "" || toDate != "") && DPProjectDataHeader.dateCondition.value != "") 
        {
            var dateCondition = DPProjectDataHeader.dateCondition.value;
        ...
        var dwgCode = "";
        for (var i = 1; i <= 8; i++) {
            var str = DPProjectDataHeader.all("drawingNo" + i).value;
            if (str == "") dwgCode += "_";
            else dwgCode += str;
        }

        paramStr += dwgCode + ":::";
        paramStr += DPProjectDataHeader.drawingTitle.value;
        paramStr = encodeURIComponent(paramStr);

        var rdFileName = "stxPECDPProgressView.mrd";
        if (DPProjectDataHeader.isAdmin.value == "Y") rdFileName = "stxPECDPProgressViewAdmin.mrd";

<%--  
§DESCRIPTION: 기자재 발주 관리 및 DP일정 통합관리 설계검토완료 파일 다운로드 화면
§AUTHOR (MODIFIER): Kang seonjung
§FILENAME: stxPECEquipItemPurchasingScheduleManagementFileView_2.jsp
--%>
...
<%
    ...
    try
    {
        ...
        sSql.append("            AND DRAW_COMPLETE_FLAG = 'Y'                                 \n");
        ...
        if (rs.next()) {
            ...
            errMsg = "소급 Data이거나 검토완료 문서를 찾을 수 없습니다.";
        }
    } 
    catch (Exception e)
    {

...
§FILENAME: stxPECEquipItemPurchasingScheduleManagementSearchHeader.jsp
§CHANGING HISTORY: 
...
<script language="javascript">
    ...
    function dataSearch()
    {
        ...
        var urlStr = "stxPECEquipItemPurchasingScheduleManagementSearchMain.jsp?projectNo=" + frmEquipItemPurchasingManagementHeader.projectList.value;
    ...
    function excelDownload()
    {
       ...
       mainForm.action="stxPECEquipItemPurchasingScheduleManagementSearchExcelDownload.jsp";
    ...
    function departmentSelChanged()
    {
        ...
        // GET 방식 전송
        xmlHttp.open("GET", "stxPECEquipItemPurchasingScheduleManagementSearchPartPersons.jsp?departCode=" + frmEquipItemPurchasingManagementHeader.departmentList.value , false);
    ...
    {
        var url = "stxPECEquipItemPurchasingScheduleManagementRegisterFS.jsp";

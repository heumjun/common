<%--  
§TITLE: 호선 별 시수조회 화면 Header 부분
§AUTHOR (MODIFIER): Hyesoo Kim
§FILENAME: stxPECDPProjectDataHeader.jsp
§CHANGING HISTORY: 
    ...
    <table width="100%" cellSpacing="0" border="1" align="left">
        ...
        <tr height="30">
            ...
            <td>
                ...
                <% if (isAdmin.equals("Y")) { %>
                <input type="button" name="erpIFButton" value='ERP INTERFACE' class="button_simple" style="width:130px" onclick="showERPIFWin();"/>
                <% } %>
            </td>
        </tr>
...
<script language="javascript">
    ...
    function viewDPInputsList()
    {
        ...
        var urlStr = "stxPECDPProjectDataMain.jsp?";
        ...
        urlStr += "&designerID=" + DPProjectDataHeader.designerList.value;
        urlStr += "&firstCall=N";
    ...
    parent.DP_PROJECTDATA_MAIN.location = "stxPECDPProjectDataMain.jsp?firstCall=Y"; 

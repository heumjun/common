...
§FILENAME: stxPECEquipItemPurchasingScheduleManagementRegisterHeader.jsp
§CHANGING HISTORY: 
...
<%
    ...
    //기술영업 : 견적기획P=416100, 상선기술영업팀=428000,상선기술영업-상선기술영업1P=428300, 상선기술영업-상선기술영업2P=428400,가스선기술영업팀=396000,가스선기술영업-가스선기술영업1P=396100,가스선기술영업-가스선기술영업2P=396200

    // 접속자가 기술영업 쪽인가?
    if("416100".equals(insaDepartmentCode) || "428000".equals(insaDepartmentCode) || "428300".equals(insaDepartmentCode) || "428400".equals(insaDepartmentCode) || "396000".equals(insaDepartmentCode) || "396100".equals(insaDepartmentCode) || "396200".equals(insaDepartmentCode) || "202077".equals(loginID) || "197046".equals(loginID) || "196146".equals(loginID) || "207069".equals(loginID) || "207309".equals(loginID) || "207087".equals(loginID) || "198023".equals(loginID) || "209452".equals(loginID))
    {
        inputMakerList = true;
        inputMakerListYN = "Y";
...
<script language="javascript">
    ...
    function dataSearch()
    {
        ...
        // 조회
        var urlStr = "stxPECEquipItemPurchasingScheduleManagementRegisterMain.jsp?projectNo=" + frmEquipItemPurchasingManagementHeader.projectList.value;
    ...
    function createPR()
    {
        ...
        if(confirm("PR 1건 당 30초 가량의 시간이 소요되오니, 결과가 나올때까지 기다려주십시오. 진행하시겠습니까?"))
        {
            ...
            mainForm.action = "stxPECEquipItemPurchasingScheduleManagementRegisterCreatePR.jsp";
    ...
    function requestComplete()
    {
        ...
        mainForm.encoding = "multipart/form-data";
        mainForm.action = "stxPECEquipItemPurchasingScheduleManagementRegisterRequestComplete.jsp";
        mainForm.submit();     
    ...
    function makerListSave()
    {
        ...
        if (resultMsg == "Y") {
            ...
            var urlStr = "stxPECEquipItemPurchasingScheduleManagementRegisterMain.jsp?projectNo=" + document.frmEquipItemPurchasingManagementHeader.projectList.value;
    ...
    function callMakerListSaveAjaxPostProc(params)
    {
        ...
        // POST 방식 전송
        xmlHttp.open("POST", "stxPECEquipItemPurchasingScheduleManagementRegisterMakerListSave.jsp?" , false);
    ...
    function searchModePageLoad()
    {
        ...
        var url = "stxPECEquipItemPurchasingScheduleManagementSearchFS.jsp";
    ...
    function createPR_Addition()
    {
        ...
        {            
            ...
            // GET 방식 전송
            xmlHttp.open("GET", "stxPECEquipItemPurchasingScheduleManagementRegisterPRApprovedCheck.jsp?projectNo="+ projectNo+"&drawingNo="+drawingNo , false);
            xmlHttp.send(null);
        ...
        if(true)
        {
            var url = "stxPECEquipItemPurchasingScheduleManagementRegisterPRAddition.jsp?projectNo=" + projectNo;
    ...
    function searchEquipDate()
    {
        ...
        if(true)
        {
            var url = "stxPECEquipItemPurchasingScheduleManagementRegisterSearchEquipDate.jsp?projectNo=" + projectNo;

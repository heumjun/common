...
<%
	...
	String buyerClassProjectManagerHead = "";
	String buyerClassProjectManagerBody	= "";

	buyerClassProjectManagerHead = "stxPECBuyerClassProjectManagerHead.jsp";
	buyerClassProjectManagerBody = "stxPECBuyerClassProjectManagerBody.jsp";
	...
	<frameset rows="<%=framesetRows%>" framespacing="0" frameborder="no" border="0">
		<frame name="listHead" src="<%=buyerClassProjectManagerHead %>" marginheight="10" marginwidth="10" scrolling="no"/>
		<frame name="listBody" src="<%=buyerClassProjectManagerBody%>" marginheight="10" marginwidth="10" />

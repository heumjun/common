...
§FILENAME: stxPECDPDepartmentDataMain.jsp
§CHANGING HISTORY: 
...
<%!
	...
	private ArrayList getDesignMHSummaryByDepartment(String dateFrom, String dateTo, String deptCodeList, String projectNoList, 
	String factorCase) throws Exception
	{
		...
		try {
			...
			queryStr.append("           DECODE(NVL(OP1_WTIME,0)+NVL(OP2_WTIME,0)+NVL(OP3_WTIME,0)+NVL(OP4_WTIME,0)+NVL(OP5_WTIME,0),0, '',   ");
			...
			queryStr.append("           DECODE(NVL(OP6_WTIME, 0) + NVL(OP7_WTIME, 0) + NVL(OP8_WTIME, 0), 0, '',                             ");
			...
			queryStr.append("                               DCC_DEPTCODE D                                                                   ");
			queryStr.append("                         WHERE 1 = 1                                                                            ");
			...
			queryStr.append("                  )                                                                                             ");
			queryStr.append("              )                                                                                                 ");
			queryStr.append("             GROUP BY DEPT_CODE, OP_CODE, ORDERNO                                                               ");
			queryStr.append("          )                                                                                                     ");
			queryStr.append("         GROUP BY DEPT_CODE, ORDERNO                                                                            ");
			queryStr.append("         ORDER BY ORDERNO                                                                                       ");
			queryStr.append("      )                                                                                                         ");
			queryStr.append("  ) A, STX_COM_INSA_DEPT@STXERP B                                                                               ");
			...
			while (rset.next()) {
				...
				resultMap.put("DEPT_NAME", rset.getString(17) == null ? "" : rset.getString(17));
...
<%
    ...
    try {
        if (!firstCall.equals("Y")) {
            ...
            dpInputsList = getDesignMHSummaryByDepartment(dateFrom, dateTo, deptCode, projectNo, factorCase);
        }
    }
    catch (Exception e) {
        errStr = e.toString();
...
<form name="DPDepartmentDataMain">
    ...
    <table width="100%" cellSpacing="1" cellpadding="0" border="0" align="center" bgcolor="#cccccc">
        <tr height="20" bgcolor="#e5e5e5">
            ...
            <td class="td_standardBold" rowspan="2">부서명</td>
        ...
        %>
            <tr height="20" style="background-color:#dddddd">
                <td colspan="3" class="td_standardRight" style="font-weight:bold;">TOTAL&nbsp;</td>

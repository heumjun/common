...
<tr>
    <td>
		<table width="100%">
		   <tr height="30">
			   <td width="60%" style="font-size: 15pt; font-weight: bold; text-align: center; color=blue;">&nbsp;&nbsp;실적 추가 등록 </td>
...
<script language="JavaScript">
	...
	function designProcessAction()
	{
        ...
        if(confirm("실적 등록을 진행하시겠습니까?"))
        {
            ...
            mainForm.action = "stxPECBuyerClassCommentResultManagementDesignProcessAdditionAction.jsp";

...
<FRAMESET rows="33, *, 38" frameborder="0" framespacing="0">
    <FRAME src="stxPECDPApproval_HolidayCheckHeader.jsp" name="DP_HOLIDAY_HEADER" noresize scrolling="no" marginwidth="1" marginheight="1">
    ...
    <FRAME src="stxPECDPApproval_HolidayCheckBottom.jsp" name="DP_HOLIDAY_BOTTOM" noresize scrolling="no" marginwidth="10" marginheight="4">

...
<FRAMESET rows="33, *, 38" frameborder="0" framespacing="0">
    <FRAME src="stxPECDPInput_ApprovalsViewHeader.jsp" name="DP_APPRVIEW_HEADER" noresize scrolling="no" marginwidth="1" marginheight="1">
    <FRAME src="stxPECDPEmpty.htm" name="DP_APPRVIEW_MAIN" noresize scrolling="auto" marginwidth="2" marginheight="2">
    <FRAME src="stxPECDPInput_ApprovalsViewBottom.jsp" name="DP_APPRVIEW_BOTTOM" noresize scrolling="no" marginwidth="10" marginheight="4">

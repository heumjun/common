...
§FILENAME: stxPECDPInputNewTimeSelect.jsp
§CHANGING HISTORY: 
    ...
    <tr valign="top">
        <td width="100%">
            <table width="100%" cellSpacing="0" cellpadding="2" border="1" align="center">
                ...
                <tr height="18">
                    <td class="td_timeselect4_1" OnMouseOver="this.style.backgroundColor='#BFFFEF'" OnMouseOut="this.style.backgroundColor='#E8E8E8'" onClick="finishWorkEarlyAfterSeaTrial();">시운전/숙직 후 조기퇴근(평일)</td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr valign="top">
        <td width="100%">
            <table width="100%" cellSpacing="0" cellpadding="2" border="1" align="center">
                ...
                -->
                <tr height="18">
                    <td class="td_timeselect4" OnMouseOver="this.style.backgroundColor='#BFFFEF'" OnMouseOut="this.style.backgroundColor='#E8E8E8'" onClick="saveAsVacationOrMilitaryTraining('D17');">년차</td>
                </tr>
                <tr height="18">
                    <td class="td_timeselect4" OnMouseOver="this.style.backgroundColor='#BFFFEF'" OnMouseOut="this.style.backgroundColor='#E8E8E8'" onClick="saveAsVacationOrMilitaryTraining('D14');">특별휴가</td>
                </tr>
                <tr height="18">
                    <td class="td_timeselect4" OnMouseOver="this.style.backgroundColor='#BFFFEF'" OnMouseOut="this.style.backgroundColor='#E8E8E8'" onClick="saveAsOneDayOverJobWithProject('B46');">사외 협의 검토<br>(공사관련 출장)</td>
                </tr>
                <tr height="18">
                    <td class="td_timeselect4" OnMouseOver="this.style.backgroundColor='#BFFFEF'" OnMouseOut="this.style.backgroundColor='#E8E8E8'" onClick="saveAsOneDayOverJob('C22');">기술회의 및 교육<br>(사내외)</td>
                </tr>
                <tr height="18">
                    <td class="td_timeselect4" OnMouseOver="this.style.backgroundColor='#BFFFEF'" OnMouseOut="this.style.backgroundColor='#E8E8E8'" onClick="saveAsOneDayOverJob('C31');">일반출장<br>(기술소위원회, 세미나)</td>
                </tr>
                <tr height="18">
                ...
                <tr height="18">
                    <td class="td_timeselect4" OnMouseOver="this.style.backgroundColor='#BFFFEF'" OnMouseOut="this.style.backgroundColor='#E8E8E8'" onClick="saveAsVacationOrMilitaryTraining('D13');">예비군 훈련(9H)</td>
                </tr>
                <!--
                <tr height="18">
...
<script language="javascript">
    ...
    function finishWorkEarlyAfterSeaTrial()
    {
        if (!isInvalidConditions()) {
            ...
            parent.DP_MAIN.finishWorkEarlyAfterSeaTrial();
        }
    }

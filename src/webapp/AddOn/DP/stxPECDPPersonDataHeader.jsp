...
<%--========================== HTML HEAD ===================================--%>
<html>
<head><title>개인 별 설계시수 조회</title></head>
...
<script language="javascript">
    ...
    function viewDPInputsList()
    {
        ...
        var urlStr = "stxPECDPPersonDataMain.jsp?";
    ...
    function viewReport()
    {
        ...
        urlStr += "stxPECDPPersonDataView.mrd&param=";
    ...
    parent.DP_PERSONDATA_MAIN.location = "stxPECDPPersonDataMain.jsp?firstCall=Y"; 

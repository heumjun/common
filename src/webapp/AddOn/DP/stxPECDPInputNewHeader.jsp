...
§FILENAME: stxPECDPInputNewHeader.jsp
§CHANGING HISTORY: 
...
<script language="javascript">
    ...
    function showDesignHoursViewWin() 
    {
        ...
        var urlStr = "stxPECDPInputNew_InputListViewFS.jsp?loginID=" + DPInputHeader.loginID.value;
    ...
    function viewDPInputs(showMsg, dateSelected, workingDayYN, MHConfirmYN, workdaysGap)
    {
        ...
        // 선택된 날짜의 시수입력 사항을 조회
        var urlStr = "stxPECDPInputNewMain.jsp?deptCode=" + ((DPInputHeader.departmentSel.value).split("|"))[0];
    ...
    dateChanged();
    parent.DP_TIMESELECT.location = "stxPECDPInputNewTimeSelect.jsp"; // Header 페이지가 먼저 로드된 후 Time Select 창이 로드되도록.
    viewDPInputs("false");

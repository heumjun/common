...
§FILENAME: stxPECEquipItemPurchasingScheduleManagementRegisterMain.jsp
§CHANGING HISTORY: 
...
<%!
	...
	private ArrayList getDeptDrawingList(String projectNo, String deptCode) throws Exception
	{
		...
		try {
			...
			queryStr.append("         ,ORIGINAL_PR_FLAG DESC                       \n"); 
			queryStr.append("         ,PR_NO                                       \n"); 
...
//if("207077".equals(loginID) && "S1573".equals(projectNo)) inputMakerListYN = "Y";
...
function searchPrPoInfo(projectNo, prNo, drawingNo)
{
    ...
    var url = "stxPECEquipItemPurchasingScheduleManagementRegisterSearchPrPoInfo.jsp?projectNo=" + projectNo;
        url += "&prNo="+prNo;
...
{
    var url = "stxPECEquipItemPurchasingScheduleManagementRegisterSearchPrDeptOwner.jsp?index=" + index;
        url += "&drawingNo="+drawingNo;
...
{
    var attURL = "stxPECEquipItemPurchasingScheduleManagementFileView.jsp?";
    attURL += "prId="+prId;
...
{
    var attURL = "stxPECEquipItemPurchasingScheduleManagementFileView_1.jsp?";
...
{
    var attURL = "stxPECEquipItemPurchasingScheduleManagementFileView_2.jsp?";
    attURL += "project="+project;
    attURL += "&drawingNo="+drawingNo;
...
<table border="0" cellpadding="0" cellspacing="0" width="1227" style="table-layout:fixed;" bgcolor="#ffffff">
    <tr>
        <td>
        <div id="header_left" style="width:630; height:30; overflow:hidden; position:absolute; left:1; top:10;">
         ...
         <div id="header_right" style="width:583; height:30; overflow:hidden;position:absolute; left:631; top:10;">
            <table width="100%" border="0" cellpadding="0" cellspacing="1" style="table-layout:fixed;" bgcolor="#cccccc">
                <tr align="center" height="28" bgcolor="#e5e5e5"> 
    ...
    <tr>
        <td>
        <div id="list_left" style="width:648; height:600; overflow:scroll; position:absolute; left:1; top:40; background-color:#ffffff" onScroll="onScrollHandler2();">
        ...
        <td width="580">
        <div id="list_right" style="width:600; height:600; overflow:scroll; position:absolute; left:631 ;top:40; background-color:#ffffff" onScroll="onScrollHandler();">
            <table border="0" cellpadding="0" cellspacing="1" bgcolor="#cccccc" style="table-layout:fixed;">

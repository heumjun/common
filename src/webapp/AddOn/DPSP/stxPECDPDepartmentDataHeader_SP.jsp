...
§FILENAME: stxPECDPDepartmentDataHeader.jsp
§CHANGING HISTORY: 
...
<script language="javascript">
    ...
    function viewDPInputsList()
    {
        ...
        var urlStr = "stxPECDPDepartmentDataMain_SP.jsp?";
    ...
    parent.DP_DPTDATA_MAIN.location = "stxPECDPDepartmentDataMain_SP.jsp?firstCall=Y"; 

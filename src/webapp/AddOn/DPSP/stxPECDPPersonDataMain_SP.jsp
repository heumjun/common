...
<%!
	...
	private ArrayList getDesignMHSummaryByPerson(String dateFrom, String dateTo, String deptCodeList, String factorCase) throws Exception
	{
		...
		try {
			...
			queryStr.append("       NVL(A.EMP_NAME, (SELECT B.NAME FROM CCC_SAWON B WHERE B.EMPLOYEE_NUM = EMPLOYEE_NO)) AS EMP_NAME,            ");
			queryStr.append("       NVL(A.POSITION,  (SELECT B.POSITION FROM CCC_SAWON B WHERE B.EMPLOYEE_NUM = EMPLOYEE_NO)) AS POSITION,       ");

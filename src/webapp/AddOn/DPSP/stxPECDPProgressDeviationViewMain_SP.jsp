...
<%
    ...
    try {
        if (!projectNo.equals("")) {
            ...
            designProgressDevList = getDesignProgressDevList(projectNo, deptCode, designerId, dateSelected, dateConditions);
            ...
            <div id="header_right" STYLE="width:563; overflow:hidden; position:relative;">
                <table id="table_header2" width="1590" border="0" cellpadding="1" cellspacing="1" bgcolor="#cccccc" style="table-layout:fiexed;">
                    <tr height="20" bgcolor="#e5e5e5"> 
                        ...
                        <td id="yardDrawingHeader7" colspan="2" class="td_smallLRMarginBlue" nowrap>REFERENCE</td>
                ...
                for (int i = 0; designProgressDevList != null && i < designProgressDevList.size(); i++)
                {
                    ...
                    <tr height="20" bgcolor="#ffffff" onMouseOver="trOnMouseOver('<%=dwgCode%>');"> 
                        ...
                        <td class="td_standardSmallYellowBack" width="200" nowrap style="text-align:left;" 
                            onclick="showDescInput(this, '<%=projectNoData%>', '<%=dwgCode%>', 'F4');" onkeydown="inputCtrlKeydownHandler();">
...
<div id="descInputDiv" style="position:absolute;display:none;">
    <input type="input" name="descInput" value="" style="width=200px;height:20px;background-color:#fff0f5;text-align:left;" onkeydown="descInputChanged();" />
</div>
...
<script language="javascript">
    ...
    { 
        ...
        if (event.keyCode != 13) return; // 엔터키가 아니면 Exit
        descInputChangedProc();
    }
    ...
    function saveDPProgressDev()
    {
        ...
        if (resultMsg == "Y") {
            ...
            var urlStr = "stxPECDPProgressDeviationViewMain_SP.jsp?projectNo=" + DPProgressDeviationMain.projectNo.value;
            urlStr += "&deptCode=" + DPProgressDeviationMain.deptCode.value;
            urlStr += "&dateSelected=" + DPProgressDeviationMain.dateSelected.value;
    ...
    {
        var urlStr = "stxPECDPProgressDeviationViewMain_SP.jsp?projectNo=" + parent.frames[0].DPProgressDeviationHeader.projectList.value;
        ...
        urlStr += "&dateSelected=" + parent.frames[0].DPProgressDeviationHeader.dateSelected.value;

...
<script language="javascript">    
    ...
    function departmentSelChanged() 
    {
		...
		xmlHttp.open("GET", "stxPECDP_GeneralAjaxProcess_SP.jsp?requestProc=GetPartPersons&departCode=" + 
    ...
    function viewInputList() 
    {
        ...
        */
        ...
        var urlStr = "stxPECDPInput_InputListViewMain_SP.jsp?";
    ...
    function printPage()
    {
        ...
        */
        ...
        var paramStr = designerIDSel + ":::" + 
                       ...
                       e3 + ":::" +  
                       departmentSel; 
        var urlStr = "http://172.16.2.13:7777/j2ee/STXDPSP/WebReport.jsp?src=<%=reportFileUrl%>stxPECDPInput_InputListView_SP.mrd&param=" + paramStr;
        window.open(urlStr, "", "");
    }

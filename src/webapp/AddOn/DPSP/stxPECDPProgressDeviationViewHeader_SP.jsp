...
<form name="DPProgressDeviationHeader">
    ...
    <table width="100%" cellSpacing="0" border="1" align="left">
        ...
        <tr height="30">
            ...
            <td width="390">호선
                <input type="text" name="projectList" value="" readonly style="width:220px;" />
            ...
            <td>
                <input type="button" name="ViewButton" value='조 회' class="button_simple" onclick="viewDPProgressDeviation();"/>
                <input type="button" name="SavaButton" value='저 장' class="button_simple" onclick="saveDPProgressDeviation();"/>
        ...
        <tr height="28">
            <td style="width:170px;" style="border-right-style:none;">관리기준일
                <input type="text" name="dateSelected" value="" class="input_small" style="width:80px;" readonly="readonly">
                <a href="javascript:showCalendar('DPProgressDeviationHeader', 'dateSelected', '', false, dateChanged);">
            ...
            <td colspan="3" rowspan="2" style="background-color:#dddddd;border-left:none;">
                ...
                <tr>
                    ...
                    <td style="font-family:Arial;font-size:9pt;padding:0px;padding-left:2px;letter-spacing:0px;">
                        ...
                        <input type="checkbox" name="bRF" value="bRF" style="width:9pt;" checked />Issued for REFERENCE
                    ...
                    <td style="font-family:Arial;font-size:9pt;padding:0px;padding-left:2px;letter-spacing:0px;">
                        ...
                        <input type="checkbox" name="mCS" value="mCS" style="width:9pt;" checked />ClassApp.Submit
                        <input type="checkbox" name="mCF" value="mCF" style="width:9pt;" checked />ClassApp.Receive<br>
                        <input type="checkbox" name="mRF" value="mRF" style="width:9pt;" checked />Issued for REFERENCE
                    ...
                    <td style="font-family:Arial;font-size:9pt;padding:0px;padding-left:2px;letter-spacing:0px;">
                        ...
                        <input type="checkbox" name="pRF" value="pRF" style="width:9pt;" />Issued for REFERENCE
...
<script language="javascript">
    ...
    parent.PROGRESS_DEV_MAIN.location = "stxPECDPProgressDeviationViewMain_SP.jsp"; // Header 페이지가 먼저 로드된 후 Main 페이지가 로드되도록.
    ...
    {
        var tmpStr = DPProgressDeviationHeader.dateSelected.value;
        if (tmpStr != null || tmpStr.trim() != "") {
            var dateStr = formatDateStr(tmpStr);
            DPProgressDeviationHeader.dateSelected.value = dateStr;
        }
    }
    ...
    function showProjectSelectWin() 
    {
        ...
        var selectedProjects = window.showModalDialog("stxPECDPProgressDeviationView_ProjectSelect_SP.jsp?" + paramStr, "", sProperties);
    ...
    function showSearchableProjects()
    {
        ...
        paramStr += "&category=DEVIATION";
        window.showModalDialog("stxPECDPProgressDeviation_ProjectSelect_SP.jsp?" + paramStr, "", sProperties);
    }
    ...
    function departmentSelChanged() 
    {
		...
		xmlHttp.open("GET", "stxPECDP_GeneralAjaxProcess_SP.jsp?requestProc=getPartPersonsForDPProgress&departCode=" + 
    ...
    function checkInputs()
    {
        ...
        //    return false;
        //}
        if (DPProgressDeviationHeader.dateSelected.value == "") {
            alert("관리기준일을 입력하십시오.");
            return false;
        }
    ...
    function viewDPProgressDeviation()
    {
        ...
        // 조회
        var urlStr = "stxPECDPProgressDeviationViewMain_SP.jsp?projectNo=" + DPProgressDeviationHeader.projectList.value;
        ...
        urlStr += "&dateSelected=" + DPProgressDeviationHeader.dateSelected.value;
    ...
    function viewReport()
    {
        var rdFileName = "stxPECDPProgressDeviationViewAdmin_SP.mrd";
    ...
    {
        viewReportProc("stxPECDPProgressDeviationViewExcel_SP.mrd");
    }
    ...
    function viewReportProc(rdFileName)
    {
        ...
        var paramStr = projectNoStrs + ":::" + 
                       ...
                       DPProgressDeviationHeader.dateSelected.value + ":::";
    ...
    DPProgressDeviationHeader.dateSelected.value = ymd;

...
=================================================================*/
	...
	function getWorkingDayYN(dateStr)
	{
		...
		xmlHttp.open("GET", "stxPECDP_GeneralAjaxProcess_SP.jsp?requestProc=GetWorkingDayYN&dateStr=" + dateStr, false);
		xmlHttp.send(null);
	...
	function callDPCommonAjaxProc(procName, paramName, paramValue)
	{
		...
		xmlHttp.open("GET", "stxPECDP_GeneralAjaxProcess_SP.jsp?requestProc=" + procName + "&" + paramName + "=" + paramValue, false);
		xmlHttp.send(null);
	...
	function callDPCommonAjaxPostProc(procName, params)
	{
        ...
        // POST 방식 전송
        xmlHttp.open("POST", "stxPECDP_GeneralAjaxProcess_SP.jsp?requestProc=" + procName , false);
	...
	function getDrawingWorkStartDate(projectNo, drawingNo)
	{
		...
		xmlHttp.open("GET", "stxPECDP_GeneralAjaxProcess_SP.jsp?" + paramStr, false);
		xmlHttp.send(null);
    ...
    function getDateDPInfo(dpDesignerID, dateSelected)
    {
        ...
        var urlStr = "stxPECDP_GeneralAjaxProcess_SP.jsp?requestProc=GetWorkingDayInfoAndConfirmYN";
    ...
    function getDesignMHConfirmExist(dpDesignerID, fromDate, toDate)
    {
        ...
        var urlStr = "stxPECDP_GeneralAjaxProcess_SP.jsp?requestProc=GetDesignMHConfirmExist";

...
<script language="javascript">
    ...
    function viewDPInputs(empNo, empName)
    {
        ...
        // 설계자의 시수입력 사항을 쿼리
        var urlStr = "stxPECDPApprovalMain_SP.jsp?empNo=" + empNo + "&empName=" + escape(encodeURIComponent(empName)) + "&dateSelected=<%=dateSelected%>";
    ...
    function saveApprovals()
    {
        ...
        xmlHttp.open("GET", "stxPECDP_GeneralAjaxProcess_SP.jsp?requestProc=SaveApprovals&applyStrs=" + toApplyStrs + 

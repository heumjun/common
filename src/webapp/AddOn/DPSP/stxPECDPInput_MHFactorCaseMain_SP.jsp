            ...
            if (DPMHFactorCaseMain.mhFactorCase.value != "add") {
                    ...
                    DPMHFactorCaseMain.defaultCaseCheck.checked == true)
                {
                    ...
                    if (updateResult == "ERROR") alert("ERROR");
                        ...
                        parent.DP_MHFACTOR_HEADER.location = "stxPECDPInput_MHFactorCaseHeader_SP.jsp";
                    }
                }
            }
            // Add 경우
                ...
                if (updateResult == "ERROR") alert("적용에 실패하였습니다!");
                    ...
                    alert("저장완료!");
                    parent.DP_MHFACTOR_HEADER.location = "stxPECDPInput_MHFactorCaseHeader_SP.jsp?selectedCaseNo=" + caseNo;
                }
            }
        }
    }

...
<FRAMESET rows="33, *, 38" frameborder="0" framespacing="0">
    <FRAME src="stxPECDPApproval_ApprovalListViewHeader_SP.jsp" name="DP_APPRLIST_HEADER" noresize scrolling="no" marginwidth="1" marginheight="1">
    ...
    <FRAME src="stxPECDPApproval_ApprovalListViewBottom_SP.jsp" name="DP_APPRLIST_BOTTOM" noresize scrolling="no" marginwidth="10" marginheight="4">

...
<FRAMESET rows="88, *, 120" frameborder="0" framespacing="0">
    <FRAME src="stxPECDPInputHeader_SP.jsp" name="DP_HEADER" noresize scrolling="no" marginwidth="1" marginheight="1">
    <FRAMESET cols="190, *" frameborder="1" framespacing="1">
        ...
        <FRAME src="stxPECDPEmpty.htm" name="DP_MAIN" noresize scrolling="auto" marginwidth="3" marginheight="20"><!--stxPECDPInputMain.jsp-->
    </FRAMESET>
    <FRAME src="stxPECDPInputBottom_SP.jsp" name="DP_BOTTOM" noresize scrolling="no" marginwidth="10" marginheight="5">

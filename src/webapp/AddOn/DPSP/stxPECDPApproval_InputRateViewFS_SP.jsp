...
<FRAMESET rows="60, *, 38" frameborder="0" framespacing="0">
    <FRAME src="stxPECDPApproval_InputRateViewHeader_SP.jsp" name="DP_RATE_HEADER" noresize scrolling="no" marginwidth="1" marginheight="1">
    ...
    <FRAME src="stxPECDPApproval_InputRateViewBottom_SP.jsp" name="DP_RATE_BOTTOM" noresize scrolling="no" marginwidth="10" marginheight="4">

...
<FRAMESET rows="91, *, 120" frameborder="0" framespacing="0">
    <FRAME src="stxPECDPApprovalHeader_SP.jsp" name="DP_APPR_HEADER" noresize scrolling="no" marginwidth="1" marginheight="1">
    ...
    <FRAME src="stxPECDPInputBottom_SP.jsp" name="DP_BOTTOM" noresize scrolling="no" marginwidth="10" marginheight="3">

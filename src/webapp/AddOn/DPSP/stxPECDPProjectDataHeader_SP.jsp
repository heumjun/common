...
<script language="javascript">
    ...
    function departmentSelChanged() 
    {
		...
		xmlHttp.open("GET", 
            "stxPECDP_GeneralAjaxProcess_SP.jsp?requestProc=GetPartPersons2&departCodes=" + DPProjectDataHeader.departmentList.value, false);
		xmlHttp.send(null);
    ...
    function viewDPInputsList()
    {
        ...
        var urlStr = "stxPECDPProjectDataMain_SP.jsp?";
    ...
    function showERPIFWin()
    {
        ...
        window.showModalDialog("stxPECDPProjectDataERPIFFS_SP.jsp?loginID=" + DPProjectDataHeader.loginID.value, null, sProperties);
    }
    ...
    parent.DP_PROJECTDATA_MAIN.location = "stxPECDPProjectDataMain_SP.jsp?firstCall=Y"; 

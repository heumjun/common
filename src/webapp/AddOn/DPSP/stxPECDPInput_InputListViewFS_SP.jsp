...
<FRAMESET rows="60, *, 60" frameborder="0" framespacing="0">
    <FRAME src="stxPECDPInput_InputListViewHeader_SP.jsp?loginID=<%=loginID%>" name="DP_VIEW_HEADER" noresize scrolling="no" marginwidth="1" marginheight="1">
    ...
    <FRAME src="stxPECDPInput_InputListViewBottom_SP.jsp" name="DP_VIEW_BOTTOM" noresize scrolling="no" marginwidth="10" marginheight="4">

...
<%
    ...
    try {
        ...
        //allProjectList.sort("PROJECTNO", "ascending", "string");
...
<script language="javascript">
    ...
    function updateSelectedProjectList()
    {
		...
		xmlHttp.open("GET", "stxPECDP_GeneralAjaxProcess_SP.jsp?requestProc=UpdateSelectedProjects&dpDesignerID=<%=designerID%>&projectList=" + selectedProjects, true);
		xmlHttp.send(null);
    }
